...
const GroveMiniTrackBall = () => (
  <board name={"GroveMiniTrackBall"} title={"Grove Mini Track Ball"} width={"42mm"} height={"32mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Mini Track Ball"} pcbX={0} pcbY={14.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-14.5} fontSize="0.45mm" />
  </board>
)

export { GroveMiniTrackBall }
export default GroveMiniTrackBall
