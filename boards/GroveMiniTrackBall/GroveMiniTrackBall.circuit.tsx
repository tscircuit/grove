...
const GroveMiniTrackBall = () => (
  <board name={"GroveMiniTrackBall"} title={"Grove Mini Track Ball"} width={"42mm"} height={"32mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <GroveConnector kind="digital" powerVoltage={"5V"} pcbX={-15} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
