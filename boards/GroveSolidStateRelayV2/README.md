...
Catalogue-level Grove interface representation for the **Actuator** family.

- Interface: `analog`
- Source: [Seeed Studio catalogue or Grove guide](https://www.seeedstudio.com/Grove-Solid-State-Relay-V2-p-3128.html)
