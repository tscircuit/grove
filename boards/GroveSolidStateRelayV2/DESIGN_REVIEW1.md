# DESIGN_REVIEW1 — Grove Solid State Relay V2

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveSolidStateRelayV2`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Solid-State-Relay-V2-p-3128.html)

This review is specific to the checked-in [board source](./GroveSolidStateRelayV2.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveSolidStateRelayV2.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveSolidStateRelayV2.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#12072(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12073(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12074(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12075(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12076(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12077(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12078(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12079(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
