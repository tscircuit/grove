...
const GroveSolidStateRelayV2 = () => (
  <board name={"GroveSolidStateRelayV2"} title={"Grove Solid State Relay V2"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
