...
const GroveLightningSensorAS3935 = () => (
  <board name={"GroveLightningSensorAS3935"} title={"Grove Lightning Sensor AS3935"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Lightning Sensor AS3935"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveLightningSensorAS3935 }
export default GroveLightningSensorAS3935
