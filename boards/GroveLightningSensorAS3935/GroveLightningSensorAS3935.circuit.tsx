...
const GroveLightningSensorAS3935 = () => (
  <board name={"GroveLightningSensorAS3935"} title={"Grove Lightning Sensor AS3935"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
