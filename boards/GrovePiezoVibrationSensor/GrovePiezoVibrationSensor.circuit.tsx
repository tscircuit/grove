...
const GrovePiezoVibrationSensor = () => (
  <board name={"GrovePiezoVibrationSensor"} title={"Grove - Piezo Vibration Sensor"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
