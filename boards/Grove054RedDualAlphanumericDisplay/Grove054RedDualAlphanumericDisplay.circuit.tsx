...
const Grove054RedDualAlphanumericDisplay = () => (
  <board name={"Grove054RedDualAlphanumericDisplay"} title={"Grove 0 54 Red Dual Alphanumeric Display"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"0 54 Red Dual Alphanumeric Disp…"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { Grove054RedDualAlphanumericDisplay }
export default Grove054RedDualAlphanumericDisplay
