...
- <trace#29301(from:.J1 > .pin4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#29302(from:.J1 > .pin3 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#29303(from:.J1 > .pin1 to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#29304(from:.J1 > .pin2 to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#29305(from:.U1 > .P1 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#29306(from:.U1 > .P4 to:net.V25) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#29307(from:.U1 > .P3 to:net.V25) /> is missing a name. Add a name prop to make the trace easier to identify.
