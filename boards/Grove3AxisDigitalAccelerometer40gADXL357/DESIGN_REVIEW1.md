# DESIGN_REVIEW1 — Grove 3 Axis Digital Accelerometer 40g ADXL357

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove3AxisDigitalAccelerometer40gADXL357`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** analog interface · sensor · 5V · primary model `ADXL357` · declared MPN `ADXL357`
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-3-Axis-Digital-Accelerometer-40g-ADXL357-p-4005.html)

This review is specific to the checked-in [board source](./Grove3AxisDigitalAccelerometer40gADXL357.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove3AxisDigitalAccelerometer40gADXL357.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove3AxisDigitalAccelerometer40gADXL357.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | ADXL357 | ADXL357 | SIG, VCC, GND, AUX |
...
- <trace#2688(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2689(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2690(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2691(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2692(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2693(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2694(from:.U2 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2695(from:.U2 > .VOUT to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
