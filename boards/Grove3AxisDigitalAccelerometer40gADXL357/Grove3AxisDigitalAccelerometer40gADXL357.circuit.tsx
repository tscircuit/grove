...
const Grove3AxisDigitalAccelerometer40gADXL357 = () => (
  <board name={"Grove3AxisDigitalAccelerometer40gADXL357"} title={"Grove 3 Axis Digital Accelerometer 40g ADXL357"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
