...
const Grove1WireThermocoupleAmplifierMAX31850K = () => (
  <board name={"Grove1WireThermocoupleAmplifierMAX31850K"} title={"Grove - 1-Wire Thermocouple Amplifier(MAX31850K)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
