...
const Grove1WireThermocoupleAmplifierMAX31850K = () => (
  <board name={"Grove1WireThermocoupleAmplifierMAX31850K"} title={"Grove - 1-Wire Thermocouple Amplifier(MAX31850K)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"1-Wire Thermocouple Amplifier(M…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { Grove1WireThermocoupleAmplifierMAX31850K }
export default Grove1WireThermocoupleAmplifierMAX31850K
