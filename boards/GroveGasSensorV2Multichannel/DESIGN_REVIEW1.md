# DESIGN_REVIEW1 — Grove - Gas Sensor V2(Multichannel)

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveGasSensorV2Multichannel`
...
This review is specific to the checked-in [board source](./GroveGasSensorV2Multichannel.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveGasSensorV2Multichannel.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveGasSensorV2Multichannel.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#6984(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6985(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6986(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6987(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6988(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6989(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6990(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6991(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
