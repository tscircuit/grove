...
const GroveGasSensorV2Multichannel = () => (
  <board name={"GroveGasSensorV2Multichannel"} title={"Grove - Gas Sensor V2(Multichannel)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Gas Sensor V2(Multichannel)"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveGasSensorV2Multichannel }
export default GroveGasSensorV2Multichannel
