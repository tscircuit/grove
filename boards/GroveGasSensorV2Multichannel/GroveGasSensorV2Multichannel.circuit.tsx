...
const GroveGasSensorV2Multichannel = () => (
  <board name={"GroveGasSensorV2Multichannel"} title={"Grove - Gas Sensor V2(Multichannel)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
