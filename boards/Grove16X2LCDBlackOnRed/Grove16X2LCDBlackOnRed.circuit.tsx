...
const Grove16X2LCDBlackOnRed = () => (
  <board name={"Grove16X2LCDBlackOnRed"} title={"Grove 16 x 2 LCD Black on Red"} width={"80mm"} height={"36mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"16 x 2 LCD Black on Red"} pcbX={0} pcbY={16.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-16.5} fontSize="0.45mm" />
  </board>
)

export { Grove16X2LCDBlackOnRed }
export default Grove16X2LCDBlackOnRed
