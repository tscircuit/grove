...
const Grove16X2LCDBlackOnRed = () => (
  <board name={"Grove16X2LCDBlackOnRed"} title={"Grove 16 x 2 LCD Black on Red"} width={"80mm"} height={"36mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
