...
const GroveVisionAIModuleV2 = () => (
  <board name={"GroveVisionAIModuleV2"} title={"Grove Vision AI Module V2"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
