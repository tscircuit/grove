# DESIGN_REVIEW1 — Grove - GPS (SIM28)

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveGPSSIM28`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** uart interface · communications · 5V · primary model `SIM28` · declared MPN `SIM28`
**Upstream reference:** [Seeed source](https://wiki.seeedstudio.com/Grove_network_module_intro/)

This review is specific to the checked-in [board source](./GroveGPSSIM28.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveGPSSIM28.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveGPSSIM28.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | SIM28 | SIM28 | RX, TX, VCC, GND, CTS, RTS, pin7, pin8 |
...
- <trace#47639(from:.U1 > .RX to:net.RX) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#47640(from:.U1 > .TX to:net.TX) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#47641(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#47642(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#47643(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#47644(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#47645(from:.R1 > .pin1 to:net.RX) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#47646(from:.R1 > .pin2 to:net.RX) /> is missing a name. Add a name prop to make the trace easier to identify.
