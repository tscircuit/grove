...
const Grove4ChannelSPDTRelay = () => (
  <board name={"Grove4ChannelSPDTRelay"} title={"Grove - 4-Channel SPDT Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
