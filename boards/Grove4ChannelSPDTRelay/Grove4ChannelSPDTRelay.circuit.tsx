...
const Grove4ChannelSPDTRelay = () => (
  <board name={"Grove4ChannelSPDTRelay"} title={"Grove - 4-Channel SPDT Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"4-Channel SPDT Relay"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { Grove4ChannelSPDTRelay }
export default Grove4ChannelSPDTRelay
