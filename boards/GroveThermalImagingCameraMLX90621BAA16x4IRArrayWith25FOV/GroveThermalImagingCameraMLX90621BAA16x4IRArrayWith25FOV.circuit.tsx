...
const GroveThermalImagingCameraMLX90621BAA16x4IRArrayWith25FOV = () => (
  <board name={"GroveThermalImagingCameraMLX90621BAA16x4IRArrayWith25FOV"} title={"Grove Thermal Imaging Camera MLX90621 BAA 16x4 IR Array with 25 FOV"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
