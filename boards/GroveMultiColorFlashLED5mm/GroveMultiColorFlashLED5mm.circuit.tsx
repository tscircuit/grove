...
const GroveMultiColorFlashLED5mm = () => (
  <board name={"GroveMultiColorFlashLED5mm"} title={"Grove Multi Color Flash LED 5mm"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Multi Color Flash LED 5mm"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveMultiColorFlashLED5mm }
export default GroveMultiColorFlashLED5mm
