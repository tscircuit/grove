...
const GroveMultiColorFlashLED5mm = () => (
  <board name={"GroveMultiColorFlashLED5mm"} title={"Grove Multi Color Flash LED 5mm"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
