...
Detailed Grove **Input** board model with a Grove 6PositionDIPSwitch controller controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `analog`
- Board family: `input`
- Primary part: `Grove 6PositionDIPSwitch controller` (MPN: `GROVE-GROVE6POSITIONDIPSWITCH`)
- Power rail: `5V`
- Source: [Seeed Studio catalogue or Grove guide](https://www.seeedstudio.com/Grove-6-Position-DIP-Switch.html)
