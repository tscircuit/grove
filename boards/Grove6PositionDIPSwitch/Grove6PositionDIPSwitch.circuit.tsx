...
const Grove6PositionDIPSwitch = () => (
  <board name={"Grove6PositionDIPSwitch"} title={"Grove 6 Position DIP Switch"} width={"42mm"} height={"32mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
