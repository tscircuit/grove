# DESIGN_REVIEW1 — Grove 6 Position DIP Switch

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove6PositionDIPSwitch`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-6-Position-DIP-Switch.html)

This review is specific to the checked-in [board source](./Grove6PositionDIPSwitch.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove6PositionDIPSwitch.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove6PositionDIPSwitch.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#3517(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#3518(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#3519(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#3520(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#3521(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#3522(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#3523(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#3524(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
