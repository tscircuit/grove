...
const GroveLEDMatrixDriverHT16K33 = () => (
  <board name={"GroveLEDMatrixDriverHT16K33"} title={"Grove - LED Matrix Driver (HT16K33)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"LED Matrix Driver (HT16K33)"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveLEDMatrixDriverHT16K33 }
export default GroveLEDMatrixDriverHT16K33
