...
const GroveLEDMatrixDriverHT16K33 = () => (
  <board name={"GroveLEDMatrixDriverHT16K33"} title={"Grove - LED Matrix Driver (HT16K33)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
