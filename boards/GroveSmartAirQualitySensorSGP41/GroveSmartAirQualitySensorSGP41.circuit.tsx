...
const GroveSmartAirQualitySensorSGP41 = () => (
  <board name={"GroveSmartAirQualitySensorSGP41"} title={"Grove -Smart Air Quality Sensor (SGP41)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
