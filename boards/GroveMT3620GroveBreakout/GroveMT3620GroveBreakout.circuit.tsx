...
const GroveMT3620GroveBreakout = () => (
  <board name={"GroveMT3620GroveBreakout"} title={"MT3620 Grove Breakout"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"MT3620 Grove Breakout"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveMT3620GroveBreakout }
export default GroveMT3620GroveBreakout
