...
const GroveD7SVibrationSensor = () => (
  <board name={"GroveD7SVibrationSensor"} title={"Grove - D7S Vibration Sensor"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
