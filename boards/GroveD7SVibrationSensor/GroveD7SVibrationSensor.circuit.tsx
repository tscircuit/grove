...
const GroveD7SVibrationSensor = () => (
  <board name={"GroveD7SVibrationSensor"} title={"Grove - D7S Vibration Sensor"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"D7S Vibration Sensor"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveD7SVibrationSensor }
export default GroveD7SVibrationSensor
