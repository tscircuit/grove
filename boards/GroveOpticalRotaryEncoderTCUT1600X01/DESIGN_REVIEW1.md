...
- <trace#85733(from:.U1 > .P4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85734(from:.U1 > .P2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85735(from:.U1 > .P5 to:net.SW) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85736(from:.U1 > .P1 to:net.SA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85737(from:.U1 > .P3 to:net.SB) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85738(from:.R1 > .pin1 to:net.SIGA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85739(from:.R1 > .pin2 to:net.SA) /> is missing a name. Add a name prop to make the trace easier to identify.
