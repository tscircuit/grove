# DESIGN_REVIEW1 — Grove - Optical Rotary Encoder(TCUT1600X01)

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveOpticalRotaryEncoderTCUT1600X01`
...
This review is specific to the checked-in [board source](./GroveOpticalRotaryEncoderTCUT1600X01.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveOpticalRotaryEncoderTCUT1600X01.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveOpticalRotaryEncoderTCUT1600X01.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | TCUT1600X01 | TCUT1600X01 | SIG, VCC, GND, AUX |
...
- <trace#12434(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12435(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12436(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12437(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12438(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12439(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12440(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12441(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
