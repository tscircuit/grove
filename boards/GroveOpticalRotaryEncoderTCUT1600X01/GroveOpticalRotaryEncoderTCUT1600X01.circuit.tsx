...
const GroveOpticalRotaryEncoderTCUT1600X01 = () => (
  <board name={"GroveOpticalRotaryEncoderTCUT1600X01"} title={"Grove - Optical Rotary Encoder(TCUT1600X01)"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Optical Rotary Encoder(TCUT1600…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
