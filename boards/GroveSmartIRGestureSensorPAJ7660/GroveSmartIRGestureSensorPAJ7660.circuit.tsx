...
const GroveSmartIRGestureSensorPAJ7660 = () => (
  <board name={"GroveSmartIRGestureSensorPAJ7660"} title={"Grove Smart IR Gesture Sensor (PAJ7660)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
