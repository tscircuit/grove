...
const GroveSmartIRGestureSensorPAJ7660 = () => (
  <board name={"GroveSmartIRGestureSensorPAJ7660"} title={"Grove Smart IR Gesture Sensor (PAJ7660)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Smart IR Gesture Sensor (PAJ766…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveSmartIRGestureSensorPAJ7660 }
export default GroveSmartIRGestureSensorPAJ7660
