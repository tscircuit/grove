...
const GroveCapacitiveFingerprintScanner = () => (
  <board name={"GroveCapacitiveFingerprintScanner"} title={"Grove Capacitive Fingerprint Scanner"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
