...
const Grove3AxisDigitalAccelerometer16gUltraLowPowerBMA400 = () => (
  <board name={"Grove3AxisDigitalAccelerometer16gUltraLowPowerBMA400"} title={"Grove - 3 Axis Digital Accelerometer±16g Ultra-low Power (BMA400)"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
