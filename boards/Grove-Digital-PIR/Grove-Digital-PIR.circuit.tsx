...
export const GroveDigitalPir = () => (
  <board name="GroveDigitalPir" title="Grove - Digital PIR Motion Sensor v1.0" width="20mm" height="20mm" borderRadius="1mm" solderMaskColor="blue">
    ...
    <capacitor name="C2" capacitance="100nF" footprint="0402" pcbX={-4.5} pcbY={5} pcbRotation={180} schX={1} schY={3} schOrientation="vertical" maxDecouplingTraceLength="10mm" />
    <capacitor name="C3" capacitance="10uF" footprint="0402" pcbX={4.5} pcbY={5.5} pcbRotation={180} schX={3} schY={3} schOrientation="vertical" maxDecouplingTraceLength="10mm" />
    <capacitor name="C4" capacitance="100nF" footprint="0603" pcbX={-5} pcbY={-3.5} schX={-5} schY={-3} schOrientation="vertical" maxDecouplingTraceLength="10mm" />
    <capacitor name="C5" capacitance="10uF" footprint="0603" pcbX={-2} pcbY={-3.5} schX={-3} schY={-3} schOrientation="vertical" maxDecouplingTraceLength="10mm" />
