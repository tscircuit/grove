...
const GroveWaterAtomizationV10 = () => (
  <board name={"GroveWaterAtomizationV10"} title={"Grove Water Atomization v1 0"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Water Atomization v1 0"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { GroveWaterAtomizationV10 }
export default GroveWaterAtomizationV10
