...
const GroveWaterAtomizationV10 = () => (
  <board name={"GroveWaterAtomizationV10"} title={"Grove Water Atomization v1 0"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
