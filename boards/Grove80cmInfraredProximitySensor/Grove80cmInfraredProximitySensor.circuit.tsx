...
const Grove80cmInfraredProximitySensor = () => (
  <board name={"Grove80cmInfraredProximitySensor"} title={"Grove - 80cm Infrared Proximity Sensor"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"80cm Infrared Proximity Sensor"} pcbX={0} pcbY={11.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-11.5} fontSize="0.45mm" />
  </board>
)

export { Grove80cmInfraredProximitySensor }
export default Grove80cmInfraredProximitySensor
