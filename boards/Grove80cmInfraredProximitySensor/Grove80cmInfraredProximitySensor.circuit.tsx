...
const Grove80cmInfraredProximitySensor = () => (
  <board name={"Grove80cmInfraredProximitySensor"} title={"Grove - 80cm Infrared Proximity Sensor"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
