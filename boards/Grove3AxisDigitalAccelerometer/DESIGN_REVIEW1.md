# DESIGN_REVIEW1 — Grove - 3-Axis Digital Accelerometer
...
This review is specific to the checked-in [board source](./Grove3AxisDigitalAccelerometer.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove3AxisDigitalAccelerometer.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove3AxisDigitalAccelerometer.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- Footprint strings declared in source: `jlcpcb:C9667`, `jlcpcb:C131334`, `jlcpcb:C14663`, `jlcpcb:C5446`, `jlcpcb:C15849`, `sot23`, `0603`.
...
- <trace#2442(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2443(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2444(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2445(from:.U1 > .VDDIO to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2446(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2447(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2448(from:.U1 > .NC to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2449(from:.U2 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
