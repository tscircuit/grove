...
const GroveI2CColorSensorV2 = () => (
  <board name={"GroveI2CColorSensorV2"} title={"Grove I2C Color Sensor V2"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"I2C Color Sensor V2"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveI2CColorSensorV2 }
export default GroveI2CColorSensorV2
