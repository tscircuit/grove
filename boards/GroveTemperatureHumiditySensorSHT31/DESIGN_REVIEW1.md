...
- Footprint strings declared in source: `jlcpcb:C80862`, `sot23`, `0603`.
...
The latest generated artifacts report 2 autorouting error(s), 11 disconnected-port error(s), 11 missing-PCB-trace error(s), 19 source-pin-missing-trace warning(s), 18 unnamed-trace warning(s), 0 refdes warning(s), 0 power metadata warning(s), and 0 ground metadata warning(s).
...
- Port EP on U1 is missing a trace
