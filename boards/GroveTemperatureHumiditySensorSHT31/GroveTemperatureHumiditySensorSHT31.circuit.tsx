...
const GroveTemperatureHumiditySensorSHT31 = () => (
  <board name={"GroveTemperatureHumiditySensorSHT31"} title={"Grove Temperature Humidity Sensor SHT31"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
