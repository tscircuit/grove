...
const GroveBlueseeedDualModelHM13 = () => (
  <board name={"GroveBlueseeedDualModelHM13"} title={"Grove Blueseeed Dual model HM13"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Blueseeed Dual model HM13"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveBlueseeedDualModelHM13 }
export default GroveBlueseeedDualModelHM13
