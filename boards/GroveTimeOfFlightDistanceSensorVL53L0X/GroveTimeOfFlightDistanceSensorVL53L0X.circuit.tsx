...
const GroveTimeOfFlightDistanceSensorVL53L0X = () => (
  <board name={"GroveTimeOfFlightDistanceSensorVL53L0X"} title={"Grove - Time of Flight Distance Sensor VL53L0X"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Time of Flight Distance Sensor…"} pcbX={0} pcbY={11.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-11.5} fontSize="0.45mm" />
  </board>
)

export { GroveTimeOfFlightDistanceSensorVL53L0X }
export default GroveTimeOfFlightDistanceSensorVL53L0X
