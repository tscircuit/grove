...
const GroveTimeOfFlightDistanceSensorVL53L0X = () => (
  <board name={"GroveTimeOfFlightDistanceSensorVL53L0X"} title={"Grove - Time of Flight Distance Sensor VL53L0X"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
