...
const Grove3AxisDigitalAccelerometer400g = () => (
  <board name={"Grove3AxisDigitalAccelerometer400g"} title={"Grove 3 Axis Digital Accelerometer 400g"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
