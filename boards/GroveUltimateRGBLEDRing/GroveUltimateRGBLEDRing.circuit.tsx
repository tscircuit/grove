...
const GroveUltimateRGBLEDRing = () => (
  <board name={"GroveUltimateRGBLEDRing"} title={"Grove Ultimate RGB LED Ring"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
