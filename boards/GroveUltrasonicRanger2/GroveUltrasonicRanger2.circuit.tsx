...
const GroveUltrasonicRanger2 = () => (
  <board name={"GroveUltrasonicRanger2"} title={"Grove - Ultrasonic Ranger"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Ultrasonic Ranger"} pcbX={0} pcbY={11.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-11.5} fontSize="0.45mm" />
  </board>
)

export { GroveUltrasonicRanger2 }
export default GroveUltrasonicRanger2
