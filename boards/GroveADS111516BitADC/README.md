# Grove ADS1115 16 bit ADC

Detailed Grove **Catalogue** board model with a ADS1115 controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `i2c`
- Board family: `utility`
- Primary part: `ADS1115` (MPN: `ADS1115`)
- Power rail: `5V`
- Source: [Seeed Studio catalogue or Grove guide](https://www.seeedstudio.com/Grove-ADS1115-16-bit-ADC-p-4599.html)
