...
const GroveADS111516BitADC = () => (
  <board name={"GroveADS111516BitADC"} title={"Grove ADS1115 16 bit ADC"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"ADS1115 16 bit ADC"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveADS111516BitADC }
export default GroveADS111516BitADC
