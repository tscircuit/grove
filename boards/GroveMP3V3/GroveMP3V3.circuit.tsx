...
const GroveMP3V3 = () => (
  <board name={"GroveMP3V3"} title={"Grove MP3 V3"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"MP3 V3"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveMP3V3 }
export default GroveMP3V3
