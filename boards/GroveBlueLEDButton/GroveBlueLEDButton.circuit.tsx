...
const GroveBlueLEDButton = () => (
  <board name={"GroveBlueLEDButton"} title={"Grove Blue LED Button"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Blue LED Button"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveBlueLEDButton }
export default GroveBlueLEDButton
