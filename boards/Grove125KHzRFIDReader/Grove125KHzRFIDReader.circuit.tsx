...
const Grove125KHzRFIDReader = () => (
  <board name={"Grove125KHzRFIDReader"} title={"Grove - 125KHz RFID Reader"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"125KHz RFID Reader"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { Grove125KHzRFIDReader }
