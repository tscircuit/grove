...
const GroveFingerClipHeartRateSensorWithShell = () => (
  <board name={"GroveFingerClipHeartRateSensorWithShell"} title={"Grove Finger clip Heart Rate Sensor with shell"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
