...
- Footprint strings declared in source: `jlcpcb:C2757850`, `sot23`, `0603`.
...
The latest generated artifacts report 2 autorouting error(s), 11 disconnected-port error(s), 11 missing-PCB-trace error(s), 18 source-pin-missing-trace warning(s), 17 unnamed-trace warning(s), 0 refdes warning(s), 0 power metadata warning(s), and 0 ground metadata warning(s).
