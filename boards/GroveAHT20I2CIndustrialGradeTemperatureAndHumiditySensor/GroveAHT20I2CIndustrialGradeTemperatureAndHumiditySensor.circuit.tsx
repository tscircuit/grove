...
const GroveAHT20I2CIndustrialGradeTemperatureAndHumiditySensor = () => (
  <board name={"GroveAHT20I2CIndustrialGradeTemperatureAndHumiditySensor"} title={"Grove AHT20 I2C Industrial grade temperature and humidity sensor"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
