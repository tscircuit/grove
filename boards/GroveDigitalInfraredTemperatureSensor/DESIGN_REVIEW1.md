# DESIGN_REVIEW1 — Grove - Digital Infrared Temperature Sensor

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveDigitalInfraredTemperatureSensor`
...
This review is specific to the checked-in [board source](./GroveDigitalInfraredTemperatureSensor.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveDigitalInfraredTemperatureSensor.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveDigitalInfraredTemperatureSensor.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#5811(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5812(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5813(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5814(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5815(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5816(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5817(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5818(from:.U1 > .VSS to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
