...
const GroveDigitalInfraredTemperatureSensor = () => (
  <board name={"GroveDigitalInfraredTemperatureSensor"} title={"Grove - Digital Infrared Temperature Sensor"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
