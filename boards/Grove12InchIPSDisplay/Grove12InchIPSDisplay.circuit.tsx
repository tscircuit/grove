...
const Grove12InchIPSDisplay = () => (
  <board name={"Grove12InchIPSDisplay"} title={"Grove 1.2-inch IPS Display"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
