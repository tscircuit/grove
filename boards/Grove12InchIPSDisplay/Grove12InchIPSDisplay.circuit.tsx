...
const Grove12InchIPSDisplay = () => (
  <board name={"Grove12InchIPSDisplay"} title={"Grove 1.2-inch IPS Display"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"1.2-inch IPS Display"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { Grove12InchIPSDisplay }
export default Grove12InchIPSDisplay
