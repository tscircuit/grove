...
const GroveDryReedRelay = () => (
  <board name={"GroveDryReedRelay"} title={"Grove Dry Reed Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
