...
const Grove6AxisAccelerometerCompass = () => (
  <board name={"Grove6AxisAccelerometerCompass"} title={"Grove 6 Axis Accelerometer Compass"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"6 Axis Accelerometer Compass"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { Grove6AxisAccelerometerCompass }
export default Grove6AxisAccelerometerCompass
