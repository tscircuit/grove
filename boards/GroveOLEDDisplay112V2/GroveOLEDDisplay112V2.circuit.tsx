...
const GroveOLEDDisplay112V2 = () => (
  <board name={"GroveOLEDDisplay112V2"} title={"Grove OLED Display 1 12 V2"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"OLED Display 1 12 V2"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveOLEDDisplay112V2 }
export default GroveOLEDDisplay112V2
