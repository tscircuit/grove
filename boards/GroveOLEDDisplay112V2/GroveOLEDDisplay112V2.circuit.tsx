...
const GroveOLEDDisplay112V2 = () => (
  <board name={"GroveOLEDDisplay112V2"} title={"Grove OLED Display 1 12 V2"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
