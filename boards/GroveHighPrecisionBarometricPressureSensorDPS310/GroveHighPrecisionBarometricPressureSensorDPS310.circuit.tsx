...
const GroveHighPrecisionBarometricPressureSensorDPS310 = () => (
  <board name={"GroveHighPrecisionBarometricPressureSensorDPS310"} title={"Grove - High Precision Barometric Pressure Sensor DPS310"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"High Precision Barometric Press…"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveHighPrecisionBarometricPressureSensorDPS310 }
export default GroveHighPrecisionBarometricPressureSensorDPS310
