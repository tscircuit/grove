...
const GroveHighPrecisionBarometricPressureSensorDPS310 = () => (
  <board name={"GroveHighPrecisionBarometricPressureSensorDPS310"} title={"Grove - High Precision Barometric Pressure Sensor DPS310"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
