...
const GroveI2CFMReceiverV11 = () => (
  <board name={"GroveI2CFMReceiverV11"} title={"Grove I2C FM Receiver v1 1"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
