...
const Grove8ChannelI2CMultiplexerI2CHubTCA9548A = () => (
  <board name={"Grove8ChannelI2CMultiplexerI2CHubTCA9548A"} title={"Grove - 8 Channel I2C Multiplexer/I2C Hub (TCA9548A)"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"8 Channel I2C Multiplexer/I2C H…"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
