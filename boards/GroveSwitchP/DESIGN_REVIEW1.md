# DESIGN_REVIEW1 — Grove - Switch(P)

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveSwitchP`
...
This review is specific to the checked-in [board source](./GroveSwitchP.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveSwitchP.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveSwitchP.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#15963(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#15964(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#15965(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#15966(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#15967(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#15968(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#15969(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#15970(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
