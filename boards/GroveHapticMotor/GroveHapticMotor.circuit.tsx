...
const GroveHapticMotor = () => (
  <board name={"GroveHapticMotor"} title={"Grove Haptic Motor"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
