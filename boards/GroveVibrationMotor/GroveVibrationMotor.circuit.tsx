...
const GroveVibrationMotor = () => (
  <board name={"GroveVibrationMotor"} title={"Grove - Vibration Motor"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
