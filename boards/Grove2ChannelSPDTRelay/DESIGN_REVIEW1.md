# DESIGN_REVIEW1 — Grove - 2-Channel SPDT Relay

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove2ChannelSPDTRelay`
...
This review is specific to the checked-in [board source](./Grove2ChannelSPDTRelay.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove2ChannelSPDTRelay.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove2ChannelSPDTRelay.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#1792(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1793(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1794(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1795(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1796(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1797(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1798(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1799(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
