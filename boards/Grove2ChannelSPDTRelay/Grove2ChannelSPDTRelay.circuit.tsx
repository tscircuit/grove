...
const Grove2ChannelSPDTRelay = () => (
  <board name={"Grove2ChannelSPDTRelay"} title={"Grove - 2-Channel SPDT Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"2-Channel SPDT Relay"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { Grove2ChannelSPDTRelay }
export default Grove2ChannelSPDTRelay
