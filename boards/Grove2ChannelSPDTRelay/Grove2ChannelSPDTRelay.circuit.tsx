...
const Grove2ChannelSPDTRelay = () => (
  <board name={"Grove2ChannelSPDTRelay"} title={"Grove - 2-Channel SPDT Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
