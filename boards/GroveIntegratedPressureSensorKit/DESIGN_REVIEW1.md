...
- <trace#64735(from:.J1 > .pin4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#64736(from:.J1 > .pin3 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#64737(from:.J1 > .pin1 to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#64738(from:.J1 > .pin2 to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#64739(from:.U1 > .P1 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#64740(from:.U1 > .P4 to:net.V25) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#64741(from:.U1 > .P3 to:net.V25) /> is missing a name. Add a name prop to make the trace easier to identify.
