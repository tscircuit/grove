# DESIGN_REVIEW1 — Grove - Integrated Pressure Sensor Kit

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveIntegratedPressureSensorKit`
...
This review is specific to the checked-in [board source](./GroveIntegratedPressureSensorKit.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveIntegratedPressureSensorKit.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveIntegratedPressureSensorKit.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#6304(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6305(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6306(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6307(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6308(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6309(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6310(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6311(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
