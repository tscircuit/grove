...
const GroveExpansionNETGadgeteerCompatible = () => (
  <board name={"GroveExpansionNETGadgeteerCompatible"} title={"Grove Expansion NET Gadgeteer Compatible"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
