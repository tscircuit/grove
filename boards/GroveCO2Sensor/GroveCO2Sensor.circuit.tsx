...
const GroveCO2Sensor = () => (
  <board name={"GroveCO2Sensor"} title={"Grove - CO2 Sensor"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <GroveConnector kind="digital" powerVoltage={"5V"} pcbX={-24} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
