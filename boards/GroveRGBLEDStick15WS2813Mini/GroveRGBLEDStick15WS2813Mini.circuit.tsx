...
const GroveRGBLEDStick15WS2813Mini = () => (
  <board name={"GroveRGBLEDStick15WS2813Mini"} title={"Grove RGB LED Stick 15 WS2813 Mini"} width={"104mm"} height={"16mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <GroveConnector kind="analog" powerVoltage={"5V"} connectToNets pcbX={-46} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
    {Array.from({ length: 15 }, (_, index) => {
      ...
      return <Fragment key={name}>
        ...
        <capacitor name={`C${index + 1}`} capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" footprint="0603" maxDecouplingTraceLength={208 + "mm"} connections={{ pin1: "net.VCC", pin2: "net.GND" }} pcbX={capX} pcbY={capY} schX={-7.8 + index * 2.2} schY={4} schOrientation="vertical" />
      </Fragment>
    })}
