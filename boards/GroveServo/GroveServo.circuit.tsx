...
const GroveServo = () => (
  <board name={"GroveServo"} title={"Grove - Servo"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Servo"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
