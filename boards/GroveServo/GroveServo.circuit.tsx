...
const GroveServo = () => (
  <board name={"GroveServo"} title={"Grove - Servo"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
