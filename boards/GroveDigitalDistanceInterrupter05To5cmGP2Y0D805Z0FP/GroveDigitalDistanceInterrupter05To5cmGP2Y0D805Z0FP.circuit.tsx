...
const GroveDigitalDistanceInterrupter05To5cmGP2Y0D805Z0FP = () => (
  <board name={"GroveDigitalDistanceInterrupter05To5cmGP2Y0D805Z0FP"} title={"Grove Digital Distance Interrupter 0 5 to 5cm GP2Y0D805Z0F P"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
