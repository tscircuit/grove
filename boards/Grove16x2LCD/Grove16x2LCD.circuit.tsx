...
const Grove16x2LCD = () => (
  <board name={"Grove16x2LCD"} title={"Grove - 16x2 LCD"} width={"80mm"} height={"36mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
