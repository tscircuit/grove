...
const GroveDragroveGenericGatewayForInternetOfThings = () => (
  <board name={"GroveDragroveGenericGatewayForInternetOfThings"} title={"Dragrove Generic gateway for internet of things"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
