...
const GroveSlidePotentiometer = () => (
  <board name={"GroveSlidePotentiometer"} title={"Grove - Slide Potentiometer"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Slide Potentiometer"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
