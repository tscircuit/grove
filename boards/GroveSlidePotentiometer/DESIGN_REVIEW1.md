# DESIGN_REVIEW1 — Grove - Slide Potentiometer

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveSlidePotentiometer`
...
This review is specific to the checked-in [board source](./GroveSlidePotentiometer.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveSlidePotentiometer.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveSlidePotentiometer.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#16320(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16321(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16322(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16323(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16324(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16325(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16326(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16327(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
