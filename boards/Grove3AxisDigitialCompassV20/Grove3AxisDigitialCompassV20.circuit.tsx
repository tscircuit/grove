...
const Grove3AxisDigitialCompassV20 = () => (
  <board name={"Grove3AxisDigitialCompassV20"} title={"Grove - 3-Axis Digitial Compass v2.0"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"3-Axis Digitial Compass v2.0"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { Grove3AxisDigitialCompassV20 }
export default Grove3AxisDigitialCompassV20
