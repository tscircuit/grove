...
const GroveLightGestureColorProximitySensorTMG39931 = () => (
  <board name={"GroveLightGestureColorProximitySensorTMG39931"} title={"Grove - Light Gesture Color Proximity Sensor (TMG39931)"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <chip name="TX1" displayName={"IR transmitter"} manufacturerPartNumber={"VSMY1850"} pinLabels={{ pin1: "IN", pin2: "GND" }} pinAttributes={{ IN: { mustBeConnected: true }, GND: { requiresGround: true, mustBeConnected: true } }} footprint={"led_5mm"} pcbX={-4} pcbY={8} schX={-4} schY={2} /><chip name="RX1" displayName={"IR receiver"} manufacturerPartNumber={"GP1UXC41QS"} pinLabels={{ pin1: "OUT", pin2: "GND" }} pinAttributes={{ OUT: { mustBeConnected: true, isGpio: true }, GND: { requiresGround: true, mustBeConnected: true } }} footprint={"soic8"} pcbX={10} pcbY={8} schX={1} schY={2} /><trace name="DISTANCE_DRIVE" from="U1.SCL" to="TX1.IN" /><trace name="DISTANCE_SENSE" from="RX1.OUT" to="U1.SCL" /><trace name="DISTANCE_TX_GND" from="TX1.GND" to="J1.GND" /><trace name="DISTANCE_RX_GND" from="RX1.GND" to="J1.GND" />
