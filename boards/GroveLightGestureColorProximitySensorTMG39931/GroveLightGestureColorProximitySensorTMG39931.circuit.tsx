...
const GroveLightGestureColorProximitySensorTMG39931 = () => (
  <board name={"GroveLightGestureColorProximitySensorTMG39931"} title={"Grove - Light Gesture Color Proximity Sensor (TMG39931)"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
