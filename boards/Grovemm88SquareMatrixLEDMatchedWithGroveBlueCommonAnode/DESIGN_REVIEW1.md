...
| U1 | simple_chip | MY9221 | MY9221 | SDA, SCL, VCC, GND, ADDR, INT, pin7, pin8 |
...
| DISP1 | simple_chip | MY9221 display panel | UNSPECIFIED-DISPLAY-Grovemm88SquareMatrixLEDMatchedWithGroveBlueCommonAnode | VCC, GND, DATA |
...
- <trace#75500(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#75501(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#75502(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#75503(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#75504(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#75505(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#75506(from:.R1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
