...
const Grovemm88SquareMatrixLEDMatchedWithGroveBlueCommonAnode = () => (
  <board name={"Grovemm88SquareMatrixLEDMatchedWithGroveBlueCommonAnode"} title={"38mm 8 8 square matrix LED matched with Grove Blue Common Anode"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
