# DESIGN_REVIEW1 — Grove - 315MHz RF Kit

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove315MHzRFKit`
...
This review is specific to the checked-in [board source](./Grove315MHzRFKit.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove315MHzRFKit.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove315MHzRFKit.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#14869(from:.U1 > .RX to:net.RX) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14870(from:.U1 > .TX to:net.TX) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14871(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14872(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14873(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14874(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14875(from:.R1 > .pin1 to:net.RX) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14876(from:.R1 > .pin2 to:net.RX) /> is missing a name. Add a name prop to make the trace easier to identify.
