...
const Grove315MHzRFKit = () => (
  <board name={"Grove315MHzRFKit"} title={"Grove - 315MHz RF Kit"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"315MHz RF Kit"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { Grove315MHzRFKit }
export default Grove315MHzRFKit
