...
const Grove3AxisDigitalAccelerometer200gADXL372 = () => (
  <board name={"Grove3AxisDigitalAccelerometer200gADXL372"} title={"Grove 3 Axis Digital Accelerometer 200g ADXL372"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
