...
const GroveMilCandyTheEasiestGroveController = () => (
  <board name={"GroveMilCandyTheEasiestGroveController"} title={"MilCandy the Easiest Grove Controller"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
