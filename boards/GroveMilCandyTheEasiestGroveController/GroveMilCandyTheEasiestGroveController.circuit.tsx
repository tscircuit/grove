...
const GroveMilCandyTheEasiestGroveController = () => (
  <board name={"GroveMilCandyTheEasiestGroveController"} title={"MilCandy the Easiest Grove Controller"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"MilCandy the Easiest Grove Cont…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveMilCandyTheEasiestGroveController }
export default GroveMilCandyTheEasiestGroveController
