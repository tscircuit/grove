...
- <trace#33775(from:.J1 > .pin4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#33776(from:.J1 > .pin3 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#33777(from:.J1 > .pin1 to:net.D1) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#33778(from:.Q1 > .P2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#33779(from:.Q1 > .P3 to:net.N_2) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#33780(from:.Q1 > .P1 to:net.DRI) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#33781(from:.R1 > .pin1 to:net.D1) /> is missing a name. Add a name prop to make the trace easier to identify.
