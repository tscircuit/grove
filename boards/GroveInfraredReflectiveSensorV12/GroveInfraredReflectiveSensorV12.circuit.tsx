...
const GroveInfraredReflectiveSensorV12 = () => (
  <board name={"GroveInfraredReflectiveSensorV12"} title={"Grove Infrared Reflective Sensor v1 2"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Infrared Reflective Sensor v1 2"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveInfraredReflectiveSensorV12 }
export default GroveInfraredReflectiveSensorV12
