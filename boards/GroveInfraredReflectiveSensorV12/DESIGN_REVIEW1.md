# DESIGN_REVIEW1 — Grove Infrared Reflective Sensor v1 2

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveInfraredReflectiveSensorV12`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Infrared-Reflective-Sensor-v1-2.html)

This review is specific to the checked-in [board source](./GroveInfraredReflectiveSensorV12.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveInfraredReflectiveSensorV12.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveInfraredReflectiveSensorV12.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#8512(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#8513(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#8514(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#8515(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#8516(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#8517(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#8518(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#8519(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
