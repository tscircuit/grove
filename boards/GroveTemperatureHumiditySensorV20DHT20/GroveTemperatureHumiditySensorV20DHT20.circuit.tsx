...
const GroveTemperatureHumiditySensorV20DHT20 = () => (
  <board name={"GroveTemperatureHumiditySensorV20DHT20"} title={"Grove Temperature Humidity Sensor V2 0 DHT20"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
