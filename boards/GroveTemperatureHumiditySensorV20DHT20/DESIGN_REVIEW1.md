...
- Footprint strings declared in source: `jlcpcb:C3012627`, `0603`.
...
The latest generated artifacts report 1 autorouting error(s), 4 disconnected-port error(s), 4 missing-PCB-trace error(s), 11 source-pin-missing-trace warning(s), 10 unnamed-trace warning(s), 0 refdes warning(s), 0 power metadata warning(s), and 0 ground metadata warning(s).

### Diagnostic sample

- Port SIG on J1 is missing a trace
