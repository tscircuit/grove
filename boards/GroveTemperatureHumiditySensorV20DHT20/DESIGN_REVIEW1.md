# DESIGN_REVIEW1 — Grove Temperature Humidity Sensor V2 0 DHT20

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveTemperatureHumiditySensorV20DHT20`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** analog interface · sensor · 5V · primary model `DHT20` · declared MPN `DHT20`
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Temperature-Humidity-Sensor-V2-0-DHT20-p-4967.html)

This review is specific to the checked-in [board source](./GroveTemperatureHumiditySensorV20DHT20.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveTemperatureHumiditySensorV20DHT20.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveTemperatureHumiditySensorV20DHT20.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- Footprint strings declared in source: `jlcpcb:C3012627`, `jlcpcb:C131334`, `jlcpcb:C14663`, `0603`.
...
- <trace#16825(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16826(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16827(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16828(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16829(from:.U1 > .VDD to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16830(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16831(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16832(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
