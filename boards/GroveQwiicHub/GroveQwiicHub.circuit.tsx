...
const GroveQwiicHub = () => (
  <board name={"GroveQwiicHub"} title={"Grove Qwiic Hub"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Qwiic Hub"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
