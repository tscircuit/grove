...
const GroveWS2813RGBLEDStripWaterproof30LEDM1m = () => (
  <board name={"GroveWS2813RGBLEDStripWaterproof30LEDM1m"} title={"Grove WS2813 RGB LED Strip Waterproof 30 LED m 1m"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
