...
const GroveWS2813RGBLEDStripWaterproof30LEDM1m = () => (
  <board name={"GroveWS2813RGBLEDStripWaterproof30LEDM1m"} title={"Grove WS2813 RGB LED Strip Waterproof 30 LED m 1m"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"WS2813 RGB LED Strip Waterproof…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveWS2813RGBLEDStripWaterproof30LEDM1m }
export default GroveWS2813RGBLEDStripWaterproof30LEDM1m
