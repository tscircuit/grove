# DESIGN_REVIEW1 — Grove - Serial Bluetooth v3.0

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveSerialBluetoothV30`
...
This review is specific to the checked-in [board source](./GroveSerialBluetoothV30.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveSerialBluetoothV30.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveSerialBluetoothV30.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#95415(from:.U1 > .RX to:net.RX) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#95416(from:.U1 > .TX to:net.TX) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#95417(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#95418(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#95419(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#95420(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#95421(from:.R1 > .pin1 to:net.RX) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#95422(from:.R1 > .pin2 to:net.RX) /> is missing a name. Add a name prop to make the trace easier to identify.
