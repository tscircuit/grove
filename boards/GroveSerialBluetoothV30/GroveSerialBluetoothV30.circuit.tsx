...
const GroveSerialBluetoothV30 = () => (
  <board name={"GroveSerialBluetoothV30"} title={"Grove - Serial Bluetooth v3.0"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Serial Bluetooth v3.0"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveSerialBluetoothV30 }
export default GroveSerialBluetoothV30
