...
const GroveSerialBluetoothV30 = () => (
  <board name={"GroveSerialBluetoothV30"} title={"Grove - Serial Bluetooth v3.0"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
