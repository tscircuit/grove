...
const GroveMultichannelGasSensor = () => (
  <board name={"GroveMultichannelGasSensor"} title={"Grove - Multichannel Gas Sensor"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
