...
- <trace#42881(from:.U1 > .P4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#42882(from:.U1 > .P2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#42883(from:.U1 > .P5 to:net.SW) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#42884(from:.U1 > .P1 to:net.SA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#42885(from:.U1 > .P3 to:net.SB) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#42886(from:.R1 > .pin1 to:net.SIGA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#42887(from:.R1 > .pin2 to:net.SA) /> is missing a name. Add a name prop to make the trace easier to identify.
