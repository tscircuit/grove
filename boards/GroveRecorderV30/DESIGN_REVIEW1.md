# DESIGN_REVIEW1 — Grove Recorder v3 0

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveRecorderV30`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Recorder-v3-0.html)

This review is specific to the checked-in [board source](./GroveRecorderV30.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveRecorderV30.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveRecorderV30.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#12009(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12010(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12011(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12012(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12013(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12014(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12015(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12016(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
