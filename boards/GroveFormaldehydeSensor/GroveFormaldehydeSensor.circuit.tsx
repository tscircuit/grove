...
const GroveFormaldehydeSensor = () => (
  <board name={"GroveFormaldehydeSensor"} title={"Grove - Formaldehyde sensor"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <trace name="GROUND_RAIL" path={["J1.GND","U1.GND","C1.pin2","R_HEAT.pin2"]} />
    <trace name="SIGNAL_RAIL" path={["J1.SIG","U1.SIG"]} />
    <silkscreentext text={"Formaldehyde sensor"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
