...
const GroveTripleColorEInkDisplay154 = () => (
  <board name={"GroveTripleColorEInkDisplay154"} title={"Grove Triple Color E Ink Display 1 54"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Triple Color E Ink Display 1 54"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveTripleColorEInkDisplay154 }
export default GroveTripleColorEInkDisplay154
