...
const GroveTripleColorEInkDisplay154 = () => (
  <board name={"GroveTripleColorEInkDisplay154"} title={"Grove Triple Color E Ink Display 1 54"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
