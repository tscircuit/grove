# DESIGN_REVIEW1 — Grove Vibration Sensor SW 420

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveVibrationSensorSW420`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** analog interface · sensor · 5V · primary model `SW-420` · declared MPN `SW-420`
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Vibration-Sensor-SW-420.html)

This review is specific to the checked-in [board source](./GroveVibrationSensorSW420.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveVibrationSensorSW420.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveVibrationSensorSW420.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | SW-420 | SW-420 | SIG, VCC, GND, AUX |
...
- <trace#19722(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19723(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19724(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19725(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19726(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19727(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19728(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19729(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
