...
const GroveVibrationSensorSW420 = () => (
  <board name={"GroveVibrationSensorSW420"} title={"Grove Vibration Sensor SW 420"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
