...
const GroveVibrationSensorSW420 = () => (
  <board name={"GroveVibrationSensorSW420"} title={"Grove Vibration Sensor SW 420"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Vibration Sensor SW 420"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveVibrationSensorSW420 }
export default GroveVibrationSensorSW420
