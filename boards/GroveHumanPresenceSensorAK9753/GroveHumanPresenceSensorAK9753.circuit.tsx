...
const GroveHumanPresenceSensorAK9753 = () => (
  <board name={"GroveHumanPresenceSensorAK9753"} title={"Grove Human Presence Sensor AK9753"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Human Presence Sensor AK9753"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveHumanPresenceSensorAK9753 }
export default GroveHumanPresenceSensorAK9753
