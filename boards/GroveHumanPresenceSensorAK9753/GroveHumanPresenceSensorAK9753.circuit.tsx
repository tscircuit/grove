...
const GroveHumanPresenceSensorAK9753 = () => (
  <board name={"GroveHumanPresenceSensorAK9753"} title={"Grove Human Presence Sensor AK9753"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
