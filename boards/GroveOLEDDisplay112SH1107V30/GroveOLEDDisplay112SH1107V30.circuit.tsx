...
const GroveOLEDDisplay112SH1107V30 = () => (
  <board name={"GroveOLEDDisplay112SH1107V30"} title={"Grove OLED Display 1 12 SH1107 V3 0"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
