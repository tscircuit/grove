...
const GroveLaserPM25SensorHM3301 = () => (
  <board name={"GroveLaserPM25SensorHM3301"} title={"Grove - Laser PM2.5 Sensor (HM3301)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
