...
const GroveLaserPM25SensorHM3301 = () => (
  <board name={"GroveLaserPM25SensorHM3301"} title={"Grove - Laser PM2.5 Sensor (HM3301)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Laser PM2.5 Sensor (HM3301)"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveLaserPM25SensorHM3301 }
export default GroveLaserPM25SensorHM3301
