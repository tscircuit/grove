...
const GroveThermalImagingCameraIRArrayMLX90640110Degree = () => (
  <board name={"GroveThermalImagingCameraIRArrayMLX90640110Degree"} title={"Grove Thermal Imaging Camera IR Array MLX90640 110 degree"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
