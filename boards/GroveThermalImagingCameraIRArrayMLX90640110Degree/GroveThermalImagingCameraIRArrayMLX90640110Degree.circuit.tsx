...
const GroveThermalImagingCameraIRArrayMLX90640110Degree = () => (
  <board name={"GroveThermalImagingCameraIRArrayMLX90640110Degree"} title={"Grove Thermal Imaging Camera IR Array MLX90640 110 degree"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
...
export { GroveThermalImagingCameraIRArrayMLX90640110Degree }
export default GroveThermalImagingCameraIRArrayMLX90640110Degree
