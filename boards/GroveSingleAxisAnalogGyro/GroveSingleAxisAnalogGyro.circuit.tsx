...
const GroveSingleAxisAnalogGyro = () => (
  <board name={"GroveSingleAxisAnalogGyro"} title={"Grove Single Axis Analog Gyro"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
