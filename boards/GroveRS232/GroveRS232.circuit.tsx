...
const GroveRS232 = () => (
  <board name={"GroveRS232"} title={"Grove RS232"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"RS232"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
