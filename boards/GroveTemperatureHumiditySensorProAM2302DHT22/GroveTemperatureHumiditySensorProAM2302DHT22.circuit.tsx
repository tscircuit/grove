...
const GroveTemperatureHumiditySensorProAM2302DHT22 = () => (
  <board name={"GroveTemperatureHumiditySensorProAM2302DHT22"} title={"Grove Temperature Humidity Sensor Pro AM2302 DHT22"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
