...
const GroveTemperatureHumiditySensorProAM2302DHT22 = () => (
  <board name={"GroveTemperatureHumiditySensorProAM2302DHT22"} title={"Grove Temperature Humidity Sensor Pro AM2302 DHT22"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Temperature Humidity Sensor Pro…"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveTemperatureHumiditySensorProAM2302DHT22 }
export default GroveTemperatureHumiditySensorProAM2302DHT22
