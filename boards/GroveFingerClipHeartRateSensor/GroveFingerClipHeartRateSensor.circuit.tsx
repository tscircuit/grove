...
const GroveFingerClipHeartRateSensor = () => (
  <board name={"GroveFingerClipHeartRateSensor"} title={"Grove - Finger-clip Heart Rate Sensor"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
