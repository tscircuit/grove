...
const GroveSerialLCD = () => (
  <board name={"GroveSerialLCD"} title={"Grove Serial LCD"} width={"80mm"} height={"36mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Serial LCD"} pcbX={0} pcbY={16.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-16.5} fontSize="0.45mm" />
  </board>
)

export { GroveSerialLCD }
