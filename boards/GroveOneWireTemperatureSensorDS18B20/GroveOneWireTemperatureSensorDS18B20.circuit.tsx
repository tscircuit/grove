...
const GroveOneWireTemperatureSensorDS18B20 = () => (
  <board name={"GroveOneWireTemperatureSensorDS18B20"} title={"One Wire Temperature Sensor DS18B20"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
