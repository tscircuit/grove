...
const GroveOneWireTemperatureSensorDS18B20 = () => (
  <board name={"GroveOneWireTemperatureSensorDS18B20"} title={"One Wire Temperature Sensor DS18B20"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"One Wire Temperature Sensor DS1…"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveOneWireTemperatureSensorDS18B20 }
