...
const GroveLoRaRadio868MHz = () => (
  <board name={"GroveLoRaRadio868MHz"} title={"Grove LoRa Radio 868MHz"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"LoRa Radio 868MHz"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveLoRaRadio868MHz }
