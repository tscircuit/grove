...
const GroveInfraredTemperatureSensorArrayAMG8833 = () => (
  <board name={"GroveInfraredTemperatureSensorArrayAMG8833"} title={"Grove - Infrared Temperature Sensor Array(AMG8833)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Infrared Temperature Sensor Arr…"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveInfraredTemperatureSensorArrayAMG8833 }
export default GroveInfraredTemperatureSensorArrayAMG8833
