...
const GroveInfraredTemperatureSensorArrayAMG8833 = () => (
  <board name={"GroveInfraredTemperatureSensorArrayAMG8833"} title={"Grove - Infrared Temperature Sensor Array(AMG8833)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
