...
const GroveSerialBlueseeedCSRBC417 = () => (
  <board name={"GroveSerialBlueseeedCSRBC417"} title={"Grove Serial Blueseeed CSR BC417"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
