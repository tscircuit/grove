...
const GroveSerialBlueseeedCSRBC417 = () => (
  <board name={"GroveSerialBlueseeedCSRBC417"} title={"Grove Serial Blueseeed CSR BC417"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Serial Blueseeed CSR BC417"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveSerialBlueseeedCSRBC417 }
export default GroveSerialBlueseeedCSRBC417
