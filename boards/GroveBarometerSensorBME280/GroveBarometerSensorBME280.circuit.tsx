...
const GroveBarometerSensorBME280 = () => (
  <board name={"GroveBarometerSensorBME280"} title={"Grove - Barometer Sensor(BME280)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <trace name="GROUND_RAIL" path={["J1.GND","U1.GND1","U1.GND2","U2.GND","C2.pin2","C1.pin2","C_ENVIRONMENTAL.pin2"]} />
    <trace name="I2C_SCL" path={["J1.SCL","U1.SCL","R1.pin2"]} />
    <trace name="I2C_SDA" path={["J1.SDA","U1.SDA","R2.pin2"]} />
    <silkscreentext text={"Barometer Sensor(BME280)"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveBarometerSensorBME280 }
