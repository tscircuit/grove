...
const GroveOLEDYellowBlueDisplay096SSD1315SPIIIC33V5V = () => (
  <board name={"GroveOLEDYellowBlueDisplay096SSD1315SPIIIC33V5V"} title={"Grove - OLED Yellow&Blue Display 0.96(SSD1315) - SPI/IIC -3.3V/5V"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"OLED Yellow&Blue Display 0.96(S…"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveOLEDYellowBlueDisplay096SSD1315SPIIIC33V5V }
export default GroveOLEDYellowBlueDisplay096SSD1315SPIIIC33V5V
