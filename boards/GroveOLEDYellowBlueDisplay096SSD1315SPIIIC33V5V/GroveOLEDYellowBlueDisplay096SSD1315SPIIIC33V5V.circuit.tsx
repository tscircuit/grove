...
const GroveOLEDYellowBlueDisplay096SSD1315SPIIIC33V5V = () => (
  <board name={"GroveOLEDYellowBlueDisplay096SSD1315SPIIIC33V5V"} title={"Grove - OLED Yellow&Blue Display 0.96(SSD1315) - SPI/IIC -3.3V/5V"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
