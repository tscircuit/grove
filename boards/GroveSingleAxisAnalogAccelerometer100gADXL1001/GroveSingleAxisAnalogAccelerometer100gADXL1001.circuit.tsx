...
const GroveSingleAxisAnalogAccelerometer100gADXL1001 = () => (
  <board name={"GroveSingleAxisAnalogAccelerometer100gADXL1001"} title={"Grove Single Axis Analog Accelerometer 100g ADXL1001"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Single Axis Analog Acceleromete…"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { GroveSingleAxisAnalogAccelerometer100gADXL1001 }
export default GroveSingleAxisAnalogAccelerometer100gADXL1001
