# DESIGN_REVIEW1 — Grove Single Axis Analog Accelerometer 100g ADXL1001

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveSingleAxisAnalogAccelerometer100gADXL1001`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** analog interface · sensor · 5V · primary model `ADXL1001` · declared MPN `ADXL1001`
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Single-Axis-Analog-Accelerometer-100g-ADXL1001-p-4035.html)

This review is specific to the checked-in [board source](./GroveSingleAxisAnalogAccelerometer100gADXL1001.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveSingleAxisAnalogAccelerometer100gADXL1001.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveSingleAxisAnalogAccelerometer100gADXL1001.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | ADXL1001 | ADXL1001 | SIG, VCC, GND, AUX |
...
- Footprint strings declared in source: `jlcpcb:C117051`, `jlcpcb:C131334`, `jlcpcb:C14663`, `jlcpcb:C5446`, `jlcpcb:C15849`, `sot23`, `0603`.
...
- <trace#14413(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14414(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14415(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14416(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14417(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14418(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14419(from:.U2 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14420(from:.U2 > .VOUT to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
