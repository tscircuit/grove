...
const GroveTempHumiSensorSHT41 = () => (
  <board name={"GroveTempHumiSensorSHT41"} title={"Grove Temp Humi Sensor SHT41"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
