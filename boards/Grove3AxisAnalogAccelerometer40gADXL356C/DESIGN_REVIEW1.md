# DESIGN_REVIEW1 — Grove 3 Axis Analog Accelerometer 40g ADXL356C

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove3AxisAnalogAccelerometer40gADXL356C`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** analog interface · sensor · 5V · primary model `ADXL356C` · declared MPN `ADXL356C`
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-3-Axis-Analog-Accelerometer-40g-ADXL356C-p-4006.html)

This review is specific to the checked-in [board source](./Grove3AxisAnalogAccelerometer40gADXL356C.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove3AxisAnalogAccelerometer40gADXL356C.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove3AxisAnalogAccelerometer40gADXL356C.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | ADXL356C | ADXL356C | SIG, VCC, GND, AUX |
...
- <trace#2164(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2165(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2166(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2167(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2168(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2169(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2170(from:.U2 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2171(from:.U2 > .VOUT to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
