...
const Grove3AxisAnalogAccelerometer40gADXL356C = () => (
  <board name={"Grove3AxisAnalogAccelerometer40gADXL356C"} title={"Grove 3 Axis Analog Accelerometer 40g ADXL356C"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
