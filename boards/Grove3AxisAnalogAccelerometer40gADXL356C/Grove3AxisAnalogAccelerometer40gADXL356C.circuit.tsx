...
const Grove3AxisAnalogAccelerometer40gADXL356C = () => (
  <board name={"Grove3AxisAnalogAccelerometer40gADXL356C"} title={"Grove 3 Axis Analog Accelerometer 40g ADXL356C"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"3 Axis Analog Accelerometer 40g…"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { Grove3AxisAnalogAccelerometer40gADXL356C }
export default Grove3AxisAnalogAccelerometer40gADXL356C
