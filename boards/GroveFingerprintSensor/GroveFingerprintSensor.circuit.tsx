...
const GroveFingerprintSensor = () => (
  <board name={"GroveFingerprintSensor"} title={"Grove Fingerprint Sensor"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
