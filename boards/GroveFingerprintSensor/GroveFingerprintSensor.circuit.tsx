...
const GroveFingerprintSensor = () => (
  <board name={"GroveFingerprintSensor"} title={"Grove Fingerprint Sensor"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <silkscreentext text={"Fingerprint Sensor"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveFingerprintSensor }
