...
const GroveLoRaRadio433MHz = () => (
  <board name={"GroveLoRaRadio433MHz"} title={"Grove LoRa Radio 433MHz"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"LoRa Radio 433MHz"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveLoRaRadio433MHz }
