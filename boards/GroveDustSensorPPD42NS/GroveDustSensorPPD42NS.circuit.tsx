...
const GroveDustSensorPPD42NS = () => (
  <board name={"GroveDustSensorPPD42NS"} title={"Grove Dust Sensor PPD42NS"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Dust Sensor PPD42NS"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveDustSensorPPD42NS }
export default GroveDustSensorPPD42NS
