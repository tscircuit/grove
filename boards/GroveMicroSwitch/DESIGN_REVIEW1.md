# DESIGN_REVIEW1 — Grove Micro Switch

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveMicroSwitch`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Micro-Switch.html)

This review is specific to the checked-in [board source](./GroveMicroSwitch.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveMicroSwitch.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveMicroSwitch.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#10202(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10203(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10204(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10205(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10206(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10207(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10208(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10209(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
