...
Detailed Grove **LED** board model with a Grove LEDStripDriver controller controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `analog`
- Board family: `actuator`
- Primary part: `Grove LEDStripDriver controller` (MPN: `GROVE-GROVELEDSTRIPDRIVER`)
- Power rail: `5V`
