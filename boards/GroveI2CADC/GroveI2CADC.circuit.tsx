...
const GroveI2CADC = () => (
  <board name={"GroveI2CADC"} title={"Grove- I2C ADC"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"I2C ADC"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
