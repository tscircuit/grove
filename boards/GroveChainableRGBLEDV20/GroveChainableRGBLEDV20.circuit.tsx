...
const GroveChainableRGBLEDV20 = () => (
  <board name={"GroveChainableRGBLEDV20"} title={"Grove – Chainable RGB LED V2.0"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
