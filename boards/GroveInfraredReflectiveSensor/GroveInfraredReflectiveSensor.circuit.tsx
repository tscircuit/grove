...
const GroveInfraredReflectiveSensor = () => (
  <board name={"GroveInfraredReflectiveSensor"} title={"Grove - Infrared Reflective Sensor"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Infrared Reflective Sensor"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveInfraredReflectiveSensor }
