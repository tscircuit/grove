...
- <trace#60941(from:.J1 > .pin3 to:net.N_V3) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#60942(from:.J1 > .pin4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#60943(from:.J1 > .pin2 to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#60944(from:.J1 > .pin1 to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#60945(from:.U1 > .P1 to:net.N_V3) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#60946(from:.U1 > .P4 to:net.N_V3) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#60947(from:.U1 > .P14 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#60948(from:.U1 > .P3 to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
