...
const GroveI2CTouchSensor = () => (
  <board name={"GroveI2CTouchSensor"} title={"Grove I2C Touch Sensor"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"I2C Touch Sensor"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveI2CTouchSensor }
export default GroveI2CTouchSensor
