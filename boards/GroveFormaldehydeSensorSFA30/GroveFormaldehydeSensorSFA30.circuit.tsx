...
const GroveFormaldehydeSensorSFA30 = () => (
  <board name={"GroveFormaldehydeSensorSFA30"} title={"Grove Formaldehyde Sensor SFA30"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
