...
const GroveFormaldehydeSensorSFA30 = () => (
  <board name={"GroveFormaldehydeSensorSFA30"} title={"Grove Formaldehyde Sensor SFA30"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Formaldehyde Sensor SFA30"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveFormaldehydeSensorSFA30 }
export default GroveFormaldehydeSensorSFA30
