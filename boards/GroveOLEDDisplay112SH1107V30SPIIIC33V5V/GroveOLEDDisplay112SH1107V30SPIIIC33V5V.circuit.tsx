...
const GroveOLEDDisplay112SH1107V30SPIIIC33V5V = () => (
  <board name={"GroveOLEDDisplay112SH1107V30SPIIIC33V5V"} title={"Grove - OLED Display 1.12 (SH1107) V3.0 - SPI/IIC -3.3V/5V"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
