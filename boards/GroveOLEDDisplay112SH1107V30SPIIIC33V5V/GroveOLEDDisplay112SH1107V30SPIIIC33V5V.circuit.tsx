...
const GroveOLEDDisplay112SH1107V30SPIIIC33V5V = () => (
  <board name={"GroveOLEDDisplay112SH1107V30SPIIIC33V5V"} title={"Grove - OLED Display 1.12 (SH1107) V3.0 - SPI/IIC -3.3V/5V"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"OLED Display 1.12 (SH1107) V3.0…"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveOLEDDisplay112SH1107V30SPIIIC33V5V }
export default GroveOLEDDisplay112SH1107V30SPIIIC33V5V
