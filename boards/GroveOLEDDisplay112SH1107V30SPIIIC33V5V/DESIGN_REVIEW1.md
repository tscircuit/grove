...
| U1 | simple_chip | SH1107 | SH1107 | SDA, SCL, VCC, GND, ADDR, INT, pin7, pin8 |
...
| DISP1 | simple_chip | SH1107 display panel | UNSPECIFIED-DISPLAY-GroveOLEDDisplay112SH1107V30SPIIIC33V5V | VCC, GND, DATA |
...
- <trace#84036(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#84037(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#84038(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#84039(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#84040(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#84041(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#84042(from:.R1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
