...
const GroveThermalImagingCameraMLX90621BAB16x4IRArrayWith60FOV = () => (
  <board name={"GroveThermalImagingCameraMLX90621BAB16x4IRArrayWith60FOV"} title={"Grove Thermal Imaging Camera MLX90621 BAB 16x4 IR Array with 60 FOV"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
