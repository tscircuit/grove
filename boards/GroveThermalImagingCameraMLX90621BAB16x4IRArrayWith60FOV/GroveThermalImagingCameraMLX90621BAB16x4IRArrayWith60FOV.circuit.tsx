...
const GroveThermalImagingCameraMLX90621BAB16x4IRArrayWith60FOV = () => (
  <board name={"GroveThermalImagingCameraMLX90621BAB16x4IRArrayWith60FOV"} title={"Grove Thermal Imaging Camera MLX90621 BAB 16x4 IR Array with 60 FOV"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Thermal Imaging Camera MLX90621…"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveThermalImagingCameraMLX90621BAB16x4IRArrayWith60FOV }
export default GroveThermalImagingCameraMLX90621BAB16x4IRArrayWith60FOV
