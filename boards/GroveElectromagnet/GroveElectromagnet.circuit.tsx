...
const GroveElectromagnet = () => (
  <board name={"GroveElectromagnet"} title={"Grove - Electromagnet"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
