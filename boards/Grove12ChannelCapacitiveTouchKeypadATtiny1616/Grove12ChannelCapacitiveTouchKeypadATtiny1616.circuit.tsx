...
const Grove12ChannelCapacitiveTouchKeypadATtiny1616 = () => (
  <board name={"Grove12ChannelCapacitiveTouchKeypadATtiny1616"} title={"Grove 12 Channel Capacitive Touch Keypad (ATtiny1616)"} width={"40mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"12 Channel Capacitive Touch Key…"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { Grove12ChannelCapacitiveTouchKeypadATtiny1616 }
export default Grove12ChannelCapacitiveTouchKeypadATtiny1616
