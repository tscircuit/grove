...
const Grove12ChannelCapacitiveTouchKeypadATtiny1616 = () => (
  <board name={"Grove12ChannelCapacitiveTouchKeypadATtiny1616"} title={"Grove 12 Channel Capacitive Touch Keypad (ATtiny1616)"} width={"42mm"} height={"32mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <silkscreentext text={"12 Channel Capacitive Touch Key…"} pcbX={0} pcbY={14.5} fontSize="0.6mm" />
