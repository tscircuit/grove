...
const GroveChestStrapHeartRateSensor = () => (
  <board name={"GroveChestStrapHeartRateSensor"} title={"Grove Chest Strap Heart Rate Sensor"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
