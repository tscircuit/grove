...
const Grove16X2LCDBlackOnYellow = () => (
  <board name={"Grove16X2LCDBlackOnYellow"} title={"Grove 16 x 2 LCD Black on Yellow"} width={"80mm"} height={"36mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"16 x 2 LCD Black on Yellow"} pcbX={0} pcbY={16.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-16.5} fontSize="0.45mm" />
  </board>
)

export { Grove16X2LCDBlackOnYellow }
export default Grove16X2LCDBlackOnYellow
