...
const Grove16X2LCDBlackOnYellow = () => (
  <board name={"Grove16X2LCDBlackOnYellow"} title={"Grove 16 x 2 LCD Black on Yellow"} width={"80mm"} height={"36mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
