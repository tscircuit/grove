...
const GroveAirQualitySensorSGP41 = () => (
  <board name={"GroveAirQualitySensorSGP41"} title={"Grove Air Quality Sensor SGP41"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <trace name="GROUND_RAIL" path={["J1.GND","U1.VSS","U1.EP","U2.GND","C2.pin2","C1.pin2"]} />
    <trace name="I2C_SCL" path={["J1.SCL","U1.SCL","R1.pin2"]} />
    <trace name="I2C_SDA" path={["J1.SDA","U1.SDA","R2.pin2"]} />
    <silkscreentext text={"Air Quality Sensor SGP41"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveAirQualitySensorSGP41 }
export default GroveAirQualitySensorSGP41
