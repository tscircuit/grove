...
const GroveAirQualitySensorSGP41 = () => (
  <board name={"GroveAirQualitySensorSGP41"} title={"Grove Air Quality Sensor SGP41"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
