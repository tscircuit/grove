# Grove Air Quality Sensor SGP41

Detailed Grove **Sensor** board model with a SGP41 controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `i2c`
- Board family: `sensor`
- Primary part: `SGP41` (MPN: `SGP41`)
- Power rail: `5V`
- Source: [Seeed Studio catalogue or Grove guide](https://www.seeedstudio.com/Grove-Air-Quality-Sensor-SGP41-p-5687.html)
