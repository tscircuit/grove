...
Detailed Grove **Display** board model with a Grove 16x2LCDWhiteOnBlue controller controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `i2c`
- Board family: `display`
- Primary part: `Grove 16x2LCDWhiteOnBlue controller` (MPN: `GROVE-GROVE16X2LCDWHITEONBLUE`)
- Power rail: `5V`
- Source: [Seeed Studio catalogue or Grove guide](https://www.seeedstudio.com/Grove-16x2-LCD-White-on-Blue.html)
