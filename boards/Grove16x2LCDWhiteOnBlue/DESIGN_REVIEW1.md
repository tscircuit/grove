# DESIGN_REVIEW1 — Grove 16x2 LCD White on Blue

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove16x2LCDWhiteOnBlue`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-16x2-LCD-White-on-Blue.html)

This review is specific to the checked-in [board source](./Grove16x2LCDWhiteOnBlue.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove16x2LCDWhiteOnBlue.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove16x2LCDWhiteOnBlue.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#1510(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1511(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1512(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1513(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1514(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1515(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1516(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1517(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
