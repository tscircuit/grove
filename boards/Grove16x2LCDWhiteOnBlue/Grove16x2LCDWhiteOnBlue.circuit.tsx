...
const Grove16x2LCDWhiteOnBlue = () => (
  <board name={"Grove16x2LCDWhiteOnBlue"} title={"Grove 16x2 LCD White on Blue"} width={"80mm"} height={"36mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
