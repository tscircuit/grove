...
- <trace#88534(from:.J1 > .pin3 to:net.N_V3) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#88535(from:.J1 > .pin4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#88536(from:.J1 > .pin2 to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#88537(from:.J1 > .pin1 to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#88538(from:.U1 > .P1 to:net.N_V3) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#88539(from:.U1 > .P4 to:net.N_V3) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#88540(from:.U1 > .P14 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#88541(from:.U1 > .P3 to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
