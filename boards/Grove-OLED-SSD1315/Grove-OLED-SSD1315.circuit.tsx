...
const GroveOledSsd1315 = () => (
  <board name={"GroveOledSsd1315"} title={"Grove - OLED Display 0.96 inch (SSD1315) v1.0"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"OLED Display 0.96 inch (SSD1315…"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveOledSsd1315 }
