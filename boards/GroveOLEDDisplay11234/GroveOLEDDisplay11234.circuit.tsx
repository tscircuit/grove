...
const GroveOLEDDisplay11234 = () => (
  <board name={"GroveOLEDDisplay11234"} title={"Grove - OLED Display 1.12&#34"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"OLED Display 1.12&#34"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveOLEDDisplay11234 }
export default GroveOLEDDisplay11234
