...
const GroveOLEDDisplay11234 = () => (
  <board name={"GroveOLEDDisplay11234"} title={"Grove - OLED Display 1.12&#34"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
