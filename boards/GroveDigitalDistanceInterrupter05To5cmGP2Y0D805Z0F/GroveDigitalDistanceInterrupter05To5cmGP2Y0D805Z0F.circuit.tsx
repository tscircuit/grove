...
const GroveDigitalDistanceInterrupter05To5cmGP2Y0D805Z0F = () => (
  <board name={"GroveDigitalDistanceInterrupter05To5cmGP2Y0D805Z0F"} title={"Grove Digital Distance Interrupter 0 5 to 5cm GP2Y0D805Z0F"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
