# DESIGN_REVIEW1 — Grove Digital Distance Interrupter 0 5 to 5cm GP2Y0D805Z0F

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveDigitalDistanceInterrupter05To5cmGP2Y0D805Z0F`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Digital-Distance-Interrupter-0-5-to-5cm-GP2Y0D805Z0F.html)

This review is specific to the checked-in [board source](./GroveDigitalDistanceInterrupter05To5cmGP2Y0D805Z0F.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveDigitalDistanceInterrupter05To5cmGP2Y0D805Z0F.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveDigitalDistanceInterrupter05To5cmGP2Y0D805Z0F.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#2409(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2410(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2411(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2412(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2413(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2414(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2415(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2416(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
