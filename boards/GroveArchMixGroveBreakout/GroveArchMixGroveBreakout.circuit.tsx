...
const GroveArchMixGroveBreakout = () => (
  <board name={"GroveArchMixGroveBreakout"} title={"Arch Mix Grove Breakout"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Arch Mix Grove Breakout"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveArchMixGroveBreakout }
export default GroveArchMixGroveBreakout
