...
const Grove3AxisAnalogAccelerometer20gADXL356B = () => (
  <board name={"Grove3AxisAnalogAccelerometer20gADXL356B"} title={"Grove 3 Axis Analog Accelerometer 20g ADXL356B"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"3 Axis Analog Accelerometer 20g…"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { Grove3AxisAnalogAccelerometer20gADXL356B }
export default Grove3AxisAnalogAccelerometer20gADXL356B
