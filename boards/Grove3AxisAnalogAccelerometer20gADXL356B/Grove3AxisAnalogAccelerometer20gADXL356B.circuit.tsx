...
const Grove3AxisAnalogAccelerometer20gADXL356B = () => (
  <board name={"Grove3AxisAnalogAccelerometer20gADXL356B"} title={"Grove 3 Axis Analog Accelerometer 20g ADXL356B"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
