...
const GroveTemperatureHumiditySensorDHT20 = () => (
  <board name={"GroveTemperatureHumiditySensorDHT20"} title={"Grove - Temperature&Humidity Sensor(DHT20)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
