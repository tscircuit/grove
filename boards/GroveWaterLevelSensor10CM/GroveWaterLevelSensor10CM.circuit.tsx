...
const GroveWaterLevelSensor10CM = () => (
  <board name={"GroveWaterLevelSensor10CM"} title={"Grove Water Level Sensor 10CM"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Water Level Sensor 10CM"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveWaterLevelSensor10CM }
export default GroveWaterLevelSensor10CM
