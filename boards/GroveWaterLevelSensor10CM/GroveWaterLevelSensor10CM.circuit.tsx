...
const GroveWaterLevelSensor10CM = () => (
  <board name={"GroveWaterLevelSensor10CM"} title={"Grove Water Level Sensor 10CM"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
