...
const GroveSEN5XAllInOne = () => (
  <board name={"GroveSEN5XAllInOne"} title={"Grove SEN5X All in One"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"SEN5X All in One"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveSEN5XAllInOne }
export default GroveSEN5XAllInOne
