...
const GroveI2CMiniMotorDriver = () => (
  <board name={"GroveI2CMiniMotorDriver"} title={"Grove I2C Mini Motor Driver"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"I2C Mini Motor Driver"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { GroveI2CMiniMotorDriver }
