...
const GroveTemperatureHumiditySensorProDHT22 = () => (
  <board name={"GroveTemperatureHumiditySensorProDHT22"} title={"Grove - Temperature&Humidity Sensor Pro(DHT22)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
