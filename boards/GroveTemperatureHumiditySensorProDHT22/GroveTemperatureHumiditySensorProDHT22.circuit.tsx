...
const GroveTemperatureHumiditySensorProDHT22 = () => (
  <board name={"GroveTemperatureHumiditySensorProDHT22"} title={"Grove - Temperature&Humidity Sensor Pro(DHT22)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
...
export { GroveTemperatureHumiditySensorProDHT22 }
