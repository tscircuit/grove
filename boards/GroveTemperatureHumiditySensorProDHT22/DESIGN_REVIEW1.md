# DESIGN_REVIEW1 — Grove - Temperature&Humidity Sensor Pro(DHT22)

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveTemperatureHumiditySensorProDHT22`
...
This review is specific to the checked-in [board source](./GroveTemperatureHumiditySensorProDHT22.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveTemperatureHumiditySensorProDHT22.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveTemperatureHumiditySensorProDHT22.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#13639(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13640(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13641(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13642(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13643(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13644(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13645(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13646(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
