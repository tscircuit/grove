# Grove OLED Yellow Blue Display 0 96 SSD1315 V1 0

Detailed Grove **Display** board model with a SSD1315 controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `i2c`
- Board family: `display`
- Primary part: `SSD1315` (MPN: `SSD1315`)
- Power rail: `5V`
- Source: [Seeed Studio catalogue or Grove guide](https://www.seeedstudio.com/Grove-OLED-Yellow-Blue-Display-0-96-SSD1315-V1-0-p-5010.html)
