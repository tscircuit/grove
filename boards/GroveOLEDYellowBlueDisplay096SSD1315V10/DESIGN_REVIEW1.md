# DESIGN_REVIEW1 — Grove OLED Yellow Blue Display 0 96 SSD1315 V1 0

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveOLEDYellowBlueDisplay096SSD1315V10`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-OLED-Yellow-Blue-Display-0-96-SSD1315-V1-0-p-5010.html)

This review is specific to the checked-in [board source](./GroveOLEDYellowBlueDisplay096SSD1315V10.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveOLEDYellowBlueDisplay096SSD1315V10.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveOLEDYellowBlueDisplay096SSD1315V10.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| DISP1 | simple_chip | SSD1315 display panel | UNSPECIFIED-DISPLAY-GroveOLEDYellowBlueDisplay096SSD1315V10 | VCC, GND, DATA |
...
- <trace#85167(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85168(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85169(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85170(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85171(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85172(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#85173(from:.R1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
