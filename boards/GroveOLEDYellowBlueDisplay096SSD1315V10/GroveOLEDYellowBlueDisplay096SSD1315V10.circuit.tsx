...
const GroveOLEDYellowBlueDisplay096SSD1315V10 = () => (
  <board name={"GroveOLEDYellowBlueDisplay096SSD1315V10"} title={"Grove OLED Yellow Blue Display 0 96 SSD1315 V1 0"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <GroveConnector kind="i2c" powerVoltage={"5V"} pcbX={-10} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
