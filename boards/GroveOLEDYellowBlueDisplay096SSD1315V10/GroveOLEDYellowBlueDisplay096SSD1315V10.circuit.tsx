...
const GroveOLEDYellowBlueDisplay096SSD1315V10 = () => (
  <board name={"GroveOLEDYellowBlueDisplay096SSD1315V10"} title={"Grove OLED Yellow Blue Display 0 96 SSD1315 V1 0"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <GroveConnector kind="i2c" powerVoltage={"5V"} connectToNets pcbX={-10} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
...
export { GroveOLEDYellowBlueDisplay096SSD1315V10 }
export default GroveOLEDYellowBlueDisplay096SSD1315V10
