...
const GroveI2CMotorDriverL298P = () => (
  <board name={"GroveI2CMotorDriverL298P"} title={"Grove - I2C Motor Driver (L298P)"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"I2C Motor Driver (L298P)"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { GroveI2CMotorDriverL298P }
export default GroveI2CMotorDriverL298P
