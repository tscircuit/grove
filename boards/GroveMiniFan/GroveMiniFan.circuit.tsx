...
const GroveMiniFan = () => (
  <board name={"GroveMiniFan"} title={"Grove - Mini Fan"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
