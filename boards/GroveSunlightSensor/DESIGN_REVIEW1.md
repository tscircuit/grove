# DESIGN_REVIEW1 — Grove - Sunlight Sensor

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveSunlightSensor`
...
This review is specific to the checked-in [board source](./GroveSunlightSensor.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveSunlightSensor.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveSunlightSensor.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#18875(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18876(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18877(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18878(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18879(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18880(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18881(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18882(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
