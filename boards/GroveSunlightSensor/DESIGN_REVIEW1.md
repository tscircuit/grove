...
- The "Q" prefix is being used with a <chip />, try using it with a <transistor />
- <trace#101372(from:.J1 > .pin3 to:net.N_V) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#101373(from:.J1 > .pin4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#101374(from:.J1 > .pin2 to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#101375(from:.J1 > .pin1 to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#101376(from:.U1 > .P3 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#101377(from:.U1 > .P2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
