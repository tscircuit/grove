...
const GroveTFMiniLiDAR = () => (
  <board name={"GroveTFMiniLiDAR"} title={"Grove - TF Mini LiDAR"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"TF Mini LiDAR"} pcbX={0} pcbY={11.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-11.5} fontSize="0.45mm" />
  </board>
)

export { GroveTFMiniLiDAR }
export default GroveTFMiniLiDAR
