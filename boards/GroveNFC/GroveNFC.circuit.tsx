...
const GroveNFC = () => (
  <board name={"GroveNFC"} title={"Grove NFC"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
