...
Detailed Grove **Communications** board model with a Grove NFC controller controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `i2c`
- Board family: `communications`
- Primary part: `Grove NFC controller` (MPN: `GROVE-GROVENFC`)
- Power rail: `5V`
- Source: [Seeed Studio catalogue or Grove guide](https://www.seeedstudio.com/Grove-NFC.html)
