...
- The "Q" prefix is being used with a <chip />, try using it with a <transistor />
- <trace#18948(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18949(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18950(from:.C5 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18951(from:.C5 > .pin1 to:net.N_V3) /> is missing a name. Add a name prop to make the trace easier to identify.
