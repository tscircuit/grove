# DESIGN_REVIEW1 — Grove 3 Axis Digital Compass V2

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove3AxisDigitalCompassV2`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-3-Axis-Digital-Compass-V2.html)

This review is specific to the checked-in [board source](./Grove3AxisDigitalCompassV2.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove3AxisDigitalCompassV2.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove3AxisDigitalCompassV2.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#2827(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2828(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2829(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2830(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2831(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2832(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2833(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#2834(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
