...
const Grove8ChannelSolidStateRelay = () => (
  <board name={"Grove8ChannelSolidStateRelay"} title={"Grove - 8-Channel Solid State Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
