...
const Grove8ChannelSolidStateRelay = () => (
  <board name={"Grove8ChannelSolidStateRelay"} title={"Grove - 8-Channel Solid State Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"8-Channel Solid State Relay"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { Grove8ChannelSolidStateRelay }
export default Grove8ChannelSolidStateRelay
