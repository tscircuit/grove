...
const Grove12BitMagneticRotaryPositionSensorAS5600 = () => (
  <board name={"Grove12BitMagneticRotaryPositionSensorAS5600"} title={"Grove 12 bit Magnetic Rotary Position Sensor AS5600"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
