...
const Grove12BitMagneticRotaryPositionSensorAS5600 = () => (
  <board name={"Grove12BitMagneticRotaryPositionSensorAS5600"} title={"Grove 12 bit Magnetic Rotary Position Sensor AS5600"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <capacitor name="C1" capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" footprint="0603" maxDecouplingTraceLength="100mm" connections={{ pin1: "net.VDD", pin2: "net.GND" }} pcbX={8} pcbY={-6} schX={5} schY={4} schOrientation="vertical" />
...
export { Grove12BitMagneticRotaryPositionSensorAS5600 }
export default Grove12BitMagneticRotaryPositionSensorAS5600
