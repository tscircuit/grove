# DESIGN_REVIEW1 — Grove 12 bit Magnetic Rotary Position Sensor AS5600

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove12BitMagneticRotaryPositionSensorAS5600`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-12-bit-Magnetic-Rotary-Position-Sensor-AS5600-p-4192.html)

This review is specific to the checked-in [board source](./Grove12BitMagneticRotaryPositionSensorAS5600.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove12BitMagneticRotaryPositionSensorAS5600.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove12BitMagneticRotaryPositionSensorAS5600.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- Footprint strings declared in source: `jlcpcb:C499458`, `jlcpcb:C131334`, `jlcpcb:C14663`, `jlcpcb:C5446`, `jlcpcb:C15849`, `sot23`, `0603`.
...
- <trace#782(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#783(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#784(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#785(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#786(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#787(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#788(from:.U1 > .OUT to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#789(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
