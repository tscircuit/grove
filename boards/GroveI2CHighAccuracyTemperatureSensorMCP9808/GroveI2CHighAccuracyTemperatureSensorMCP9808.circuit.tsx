...
const GroveI2CHighAccuracyTemperatureSensorMCP9808 = () => (
  <board name={"GroveI2CHighAccuracyTemperatureSensorMCP9808"} title={"Grove - I2C High Accuracy Temperature Sensor(MCP9808)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"I2C High Accuracy Temperature S…"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveI2CHighAccuracyTemperatureSensorMCP9808 }
