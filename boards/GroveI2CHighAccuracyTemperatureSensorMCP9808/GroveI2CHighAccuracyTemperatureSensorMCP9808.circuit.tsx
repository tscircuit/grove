...
const GroveI2CHighAccuracyTemperatureSensorMCP9808 = () => (
  <board name={"GroveI2CHighAccuracyTemperatureSensorMCP9808"} title={"Grove - I2C High Accuracy Temperature Sensor(MCP9808)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
