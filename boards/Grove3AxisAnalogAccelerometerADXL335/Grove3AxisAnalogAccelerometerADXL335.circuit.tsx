...
const Grove3AxisAnalogAccelerometerADXL335 = () => (
  <board name={"Grove3AxisAnalogAccelerometerADXL335"} title={"Grove 3 Axis Analog Accelerometer ADXL335"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
