...
const Grove3AxisAnalogAccelerometerADXL335 = () => (
  <board name={"Grove3AxisAnalogAccelerometerADXL335"} title={"Grove 3 Axis Analog Accelerometer ADXL335"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"3 Axis Analog Accelerometer ADX…"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { Grove3AxisAnalogAccelerometerADXL335 }
export default Grove3AxisAnalogAccelerometerADXL335
