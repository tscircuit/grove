...
const GroveHighTemperatureSensor = () => (
  <board name={"GroveHighTemperatureSensor"} title={"Grove - High Temperature Sensor"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
