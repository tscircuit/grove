...
const GroveAllInOneEnvironmentalSensorSEN54 = () => (
  <board name={"GroveAllInOneEnvironmentalSensorSEN54"} title={"Grove All in one Environmental Sensor SEN54"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <trace name="REGULATED_RAIL" path={["U2.VOUT","U1.VDD","C1.pin1","R1.pin1","R2.pin1","R_HEAT.pin1"]} />
    <trace name="GROUND_RAIL" path={["J1.GND","U1.GND","U2.GND","C2.pin2","C1.pin2","R_HEAT.pin2"]} />
    <trace name="I2C_SCL" path={["J1.SCL","U1.SCL","R1.pin2"]} />
    <trace name="I2C_SDA" path={["J1.SDA","U1.SDA","R2.pin2"]} />
    <silkscreentext text={"All in one Environmental Sensor…"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveAllInOneEnvironmentalSensorSEN54 }
export default GroveAllInOneEnvironmentalSensorSEN54
