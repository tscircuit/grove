...
const GroveAllInOneEnvironmentalSensorSEN54 = () => (
  <board name={"GroveAllInOneEnvironmentalSensorSEN54"} title={"Grove All in one Environmental Sensor SEN54"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
