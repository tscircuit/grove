...
const GroveInfraredTemperatureSensor = () => (
  <board name={"GroveInfraredTemperatureSensor"} title={"Grove - Infrared Temperature Sensor"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
