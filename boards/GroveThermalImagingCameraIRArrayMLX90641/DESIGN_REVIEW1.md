# DESIGN_REVIEW1 — Grove - Thermal Imaging Camera IR-Array MLX90641

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveThermalImagingCameraIRArrayMLX90641`
...
This review is specific to the checked-in [board source](./GroveThermalImagingCameraIRArrayMLX90641.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveThermalImagingCameraIRArrayMLX90641.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveThermalImagingCameraIRArrayMLX90641.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#108365(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108366(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108367(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108368(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108369(from:.U2 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108370(from:.U2 > .VOUT to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108371(from:.U2 > .VIN to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108372(from:.C2 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
