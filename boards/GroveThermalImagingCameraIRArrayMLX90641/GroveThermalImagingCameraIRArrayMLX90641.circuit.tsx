...
const GroveThermalImagingCameraIRArrayMLX90641 = () => (
  <board name={"GroveThermalImagingCameraIRArrayMLX90641"} title={"Grove - Thermal Imaging Camera IR-Array MLX90641"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
