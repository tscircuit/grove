...
const Grove3AxisAnalogAccelerometer = () => (
  <board name={"Grove3AxisAnalogAccelerometer"} title={"Grove - 3-Axis Analog Accelerometer"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
