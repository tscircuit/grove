...
const GroveI2CMotorDriverWithL298 = () => (
  <board name={"GroveI2CMotorDriverWithL298"} title={"Grove I2C Motor Driver with L298"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"I2C Motor Driver with L298"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { GroveI2CMotorDriverWithL298 }
export default GroveI2CMotorDriverWithL298
