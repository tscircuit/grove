...
const GroveNFCTag = () => (
  <board name={"GroveNFCTag"} title={"Grove - NFC_tag"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"NFC_tag"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
