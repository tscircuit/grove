...
const Grove25ADCCurrentSensorACS70331 = () => (
  <board name={"Grove25ADCCurrentSensorACS70331"} title={"Grove - 2.5A DC Current Sensor(ACS70331)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
