...
const Grove25ADCCurrentSensorACS70331 = () => (
  <board name={"Grove25ADCCurrentSensorACS70331"} title={"Grove - 2.5A DC Current Sensor(ACS70331)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"2.5A DC Current Sensor(ACS70331)"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { Grove25ADCCurrentSensorACS70331 }
export default Grove25ADCCurrentSensorACS70331
