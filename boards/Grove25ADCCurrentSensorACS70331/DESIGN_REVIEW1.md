# DESIGN_REVIEW1 — Grove - 2.5A DC Current Sensor(ACS70331)

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove25ADCCurrentSensorACS70331`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** analog interface · sensor · 5V · primary model `ACS70331` · declared MPN `ACS70331`
**Upstream reference:** [Seeed source](https://wiki.seeedstudio.com/Grove_Accessories_Intro/)

This review is specific to the checked-in [board source](./Grove25ADCCurrentSensorACS70331.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove25ADCCurrentSensorACS70331.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove25ADCCurrentSensorACS70331.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | ACS70331 | ACS70331 | SIG, VCC, GND, AUX |
...
- <trace#13852(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13853(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13854(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13855(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13856(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13857(from:.R1 > .pin1 to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13858(from:.R1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13859(from:.R_STATUS > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
