...
const Grove4Channel16BitADCADS1115 = () => (
  <board name={"Grove4Channel16BitADCADS1115"} title={"Grove - 4-Channel 16-bit ADC(ADS1115)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"4-Channel 16-bit ADC(ADS1115)"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
