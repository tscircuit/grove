...
Detailed Grove **Sound** board model with a Grove AnalogMicrophone controller controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `analog`
- Board family: `sensor`
- Primary part: `Grove AnalogMicrophone controller` (MPN: `GROVE-GROVEANALOGMICROPHONE`)
- Power rail: `5V`
