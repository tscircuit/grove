...
const Grove6AxisDigitalAccelerometerGyroscope40gADIS16470 = () => (
  <board name={"Grove6AxisDigitalAccelerometerGyroscope40gADIS16470"} title={"Grove 6 Axis Digital Accelerometer Gyroscope 40g ADIS16470"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <capacitor name="C_MOTION" capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" supplierPartNumbers={{ jlcpcb: ["C14663"] }} footprint="0603" maxDecouplingTraceLength="100mm" connections={{ pin1: "net.VCC", pin2: "net.GND" }} pcbX={9} pcbY={8} schX={8} schY={4} schOrientation="vertical" />
    <trace name="POWER_RAIL" path={["J1.VCC","U1.VCC","C1.pin1","C_MOTION.pin1"]} />
    <trace name="GROUND_RAIL" path={["J1.GND","U1.GND","C1.pin2","R1.pin2","C_MOTION.pin2"]} />
    <trace name="SIGNAL_RAIL" path={["J1.SIG","U1.SIG","R1.pin1"]} />
    <silkscreentext text={"6 Axis Digital Accelerometer Gy…"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { Grove6AxisDigitalAccelerometerGyroscope40gADIS16470 }
export default Grove6AxisDigitalAccelerometerGyroscope40gADIS16470
