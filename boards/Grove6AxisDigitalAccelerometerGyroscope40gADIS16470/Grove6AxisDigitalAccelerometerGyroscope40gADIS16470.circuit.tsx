...
const Grove6AxisDigitalAccelerometerGyroscope40gADIS16470 = () => (
  <board name={"Grove6AxisDigitalAccelerometerGyroscope40gADIS16470"} title={"Grove 6 Axis Digital Accelerometer Gyroscope 40g ADIS16470"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <capacitor name="C_MOTION" capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" footprint="0603" connections={{ pin1: "net.VCC", pin2: "net.GND" }} pcbX={10} pcbY={6} schX={7} schY={4} schOrientation="vertical" />
