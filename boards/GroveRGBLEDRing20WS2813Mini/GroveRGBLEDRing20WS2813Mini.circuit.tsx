...
const GroveRGBLEDRing20WS2813Mini = () => (
  <board name={"GroveRGBLEDRing20WS2813Mini"} title={"Grove - RGB LED Ring (20 - WS2813 Mini)"} width={"69mm"} height={"69mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <net name="EMITTER" />
    <net name="LOAD_NEG" />
    <GroveMountingHoles x={30.5} y={31.5} />
    {/* JLCPCB footprint imports: footprint="jlcpcb:C965558", footprint="jlcpcb:C131334", footprint="jlcpcb:C14663" */}
    <GroveConnector kind="analog" powerVoltage={"5V"} connectToNets pcbX={-28.5} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
    {Array.from({ length: 20 }, (_, index) => {
      const name = `PIX${index + 1}`
      const angle = (index / 20) * Math.PI * 2 - Math.PI / 2
      const x = 3 + Math.cos(angle) * 26.5
      const y = Math.sin(angle) * 26.5
      ...
      return <Fragment key={name}>
        ...
        <capacitor name={`C${index + 1}`} capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" supplierPartNumbers={{ jlcpcb: ["C14663"] }} footprint="0603" connections={{ pin1: "net.VCC", pin2: "net.GND" }} maxDecouplingTraceLength={138 + "mm"} pcbX={capX} pcbY={capY} schX={-7.8 + index * 2.2} schY={4} schOrientation="vertical" />
      </Fragment>
    })}
    <trace name="DATA_IN" path={["J1.SIG","PIX1.DIN"]} />
    <trace name="LED_VCC_RAIL" path={["J1.VCC","PIX1.VCC","C1.pin1","PIX2.VCC","C2.pin1","PIX3.VCC","C3.pin1","PIX4.VCC","C4.pin1","PIX5.VCC","C5.pin1","PIX6.VCC","C6.pin1","PIX7.VCC","C7.pin1","PIX8.VCC","C8.pin1","PIX9.VCC","C9.pin1","PIX10.VCC","C10.pin1","PIX11.VCC","C11.pin1","PIX12.VCC","C12.pin1","PIX13.VCC","C13.pin1","PIX14.VCC","C14.pin1","PIX15.VCC","C15.pin1","PIX16.VCC","C16.pin1","PIX17.VCC","C17.pin1","PIX18.VCC","C18.pin1","PIX19.VCC","C19.pin1","PIX20.VCC","C20.pin1"]} />
    <trace name="LED_GND_RAIL" path={["J1.GND","PIX1.GND","C1.pin2","PIX2.GND","C2.pin2","PIX3.GND","C3.pin2","PIX4.GND","C4.pin2","PIX5.GND","C5.pin2","PIX6.GND","C6.pin2","PIX7.GND","C7.pin2","PIX8.GND","C8.pin2","PIX9.GND","C9.pin2","PIX10.GND","C10.pin2","PIX11.GND","C11.pin2","PIX12.GND","C12.pin2","PIX13.GND","C13.pin2","PIX14.GND","C14.pin2","PIX15.GND","C15.pin2","PIX16.GND","C16.pin2","PIX17.GND","C17.pin2","PIX18.GND","C18.pin2","PIX19.GND","C19.pin2","PIX20.GND","C20.pin2"]} />
    <silkscreentext text={"RGB LED Ring (20 - WS2813 Mini)"} pcbX={0} pcbY={33} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-33} fontSize="0.45mm" />
  </board>
)

export { GroveRGBLEDRing20WS2813Mini }
export default GroveRGBLEDRing20WS2813Mini
