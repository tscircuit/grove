...
const GroveRGBLEDRing20WS2813Mini = () => (
  <board name={"GroveRGBLEDRing20WS2813Mini"} title={"Grove - RGB LED Ring (20 - WS2813 Mini)"} width={"72mm"} height={"72mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"RGB LED Ring (20 - WS2813 Mini)"} pcbX={0} pcbY={34.5} fontSize="0.6mm" />
