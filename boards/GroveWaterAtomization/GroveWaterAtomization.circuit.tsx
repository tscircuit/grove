...
const GroveWaterAtomization = () => (
  <board name={"GroveWaterAtomization"} title={"Grove - Water Atomization"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
