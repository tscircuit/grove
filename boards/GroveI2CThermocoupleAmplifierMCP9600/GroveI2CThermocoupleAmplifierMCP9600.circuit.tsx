...
const GroveI2CThermocoupleAmplifierMCP9600 = () => (
  <board name={"GroveI2CThermocoupleAmplifierMCP9600"} title={"Grove - I2C Thermocouple Amplifier (MCP9600)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"I2C Thermocouple Amplifier (MCP…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveI2CThermocoupleAmplifierMCP9600 }
