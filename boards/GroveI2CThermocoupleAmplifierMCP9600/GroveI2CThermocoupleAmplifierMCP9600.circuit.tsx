...
const GroveI2CThermocoupleAmplifierMCP9600 = () => (
  <board name={"GroveI2CThermocoupleAmplifierMCP9600"} title={"Grove - I2C Thermocouple Amplifier (MCP9600)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
