...
const Grove3AxisDigitalAccelerometer15g = () => (
  <board name={"Grove3AxisDigitalAccelerometer15g"} title={"Grove 3 Axis Digital Accelerometer 1 5g"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
