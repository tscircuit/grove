# DESIGN_REVIEW1 — Grove 3 Axis Digital Accelerometer 1 5g

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove3AxisDigitalAccelerometer15g`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** analog interface · sensor · 5V · primary model `MMA7660FC` · declared MPN `MMA7660FC`
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-3-Axis-Digital-Accelerometer-1-5g.html)

This review is specific to the checked-in [board source](./Grove3AxisDigitalAccelerometer15g.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove3AxisDigitalAccelerometer15g.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove3AxisDigitalAccelerometer15g.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | MMA7660FC | MMA7660FC | SIG, VCC, GND, AUX |
...
- <trace#16470(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16471(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16472(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16473(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16474(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16475(from:.R1 > .pin1 to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16476(from:.R1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#16477(from:.C_MOTION > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
