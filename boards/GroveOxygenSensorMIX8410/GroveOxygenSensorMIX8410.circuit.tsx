...
const GroveOxygenSensorMIX8410 = () => (
  <board name={"GroveOxygenSensorMIX8410"} title={"Grove Oxygen Sensor MIX8410"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
