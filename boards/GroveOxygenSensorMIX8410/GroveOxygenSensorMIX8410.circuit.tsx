...
const GroveOxygenSensorMIX8410 = () => (
  <board name={"GroveOxygenSensorMIX8410"} title={"Grove Oxygen Sensor MIX8410"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Oxygen Sensor MIX8410"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveOxygenSensorMIX8410 }
export default GroveOxygenSensorMIX8410
