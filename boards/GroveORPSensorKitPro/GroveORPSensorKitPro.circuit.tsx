...
const GroveORPSensorKitPro = () => (
  <board name={"GroveORPSensorKitPro"} title={"Grove - ORP Sensor Kit Pro"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"ORP Sensor Kit Pro"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveORPSensorKitPro }
export default GroveORPSensorKitPro
