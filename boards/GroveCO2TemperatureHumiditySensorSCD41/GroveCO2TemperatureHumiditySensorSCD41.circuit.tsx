...
const GroveCO2TemperatureHumiditySensorSCD41 = () => (
  <board name={"GroveCO2TemperatureHumiditySensorSCD41"} title={"Grove - CO2 & Temperature & Humidity Sensor (SCD41)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
...
export { GroveCO2TemperatureHumiditySensorSCD41 }
