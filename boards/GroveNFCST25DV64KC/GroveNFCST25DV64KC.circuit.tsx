...
const GroveNFCST25DV64KC = () => (
  <board name={"GroveNFCST25DV64KC"} title={"Grove NFC ST25DV64KC"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"NFC ST25DV64KC"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveNFCST25DV64KC }
export default GroveNFCST25DV64KC
