...
const GroveSmartIRGestureSensor = () => (
  <board name={"GroveSmartIRGestureSensor"} title={"Grove Smart IR Gesture Sensor"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
