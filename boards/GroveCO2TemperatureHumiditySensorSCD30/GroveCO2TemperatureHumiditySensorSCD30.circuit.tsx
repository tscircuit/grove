...
const GroveCO2TemperatureHumiditySensorSCD30 = () => (
  <board name={"GroveCO2TemperatureHumiditySensorSCD30"} title={"Grove - CO2 & Temperature & Humidity Sensor (SCD30)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
