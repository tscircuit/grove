...
const GroveCO2TemperatureHumiditySensorSCD30 = () => (
  <board name={"GroveCO2TemperatureHumiditySensorSCD30"} title={"Grove - CO2 & Temperature & Humidity Sensor (SCD30)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"CO2 & Temperature & Humidity Se…"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveCO2TemperatureHumiditySensorSCD30 }
