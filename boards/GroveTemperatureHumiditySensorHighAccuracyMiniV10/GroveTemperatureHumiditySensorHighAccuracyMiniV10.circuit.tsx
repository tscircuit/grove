...
const GroveTemperatureHumiditySensorHighAccuracyMiniV10 = () => (
  <board name={"GroveTemperatureHumiditySensorHighAccuracyMiniV10"} title={"Grove - Temperature&Humidity Sensor (High-Accuracy &Mini) v1.0"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <capacitor name="C_ENVIRONMENTAL" capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" footprint="0603" maxDecouplingTraceLength="100mm" connections={{ pin1: "net.VCC", pin2: "net.GND" }} pcbX={7} pcbY={7} schX={8} schY={4} schOrientation="vertical" />
    <trace name="POWER_RAIL" path={["J1.VCC","U1.VCC","C1.pin1","C_ENVIRONMENTAL.pin1"]} />
    <trace name="GROUND_RAIL" path={["J1.GND","U1.GND","C1.pin2","R1.pin2","C_ENVIRONMENTAL.pin2"]} />
    <trace name="SIGNAL_RAIL" path={["J1.SIG","U1.SIG","R1.pin1"]} />
    <silkscreentext text={"Temperature&Humidity Sensor (Hi…"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveTemperatureHumiditySensorHighAccuracyMiniV10 }
export default GroveTemperatureHumiditySensorHighAccuracyMiniV10
