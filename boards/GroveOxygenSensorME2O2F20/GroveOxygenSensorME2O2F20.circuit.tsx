...
const GroveOxygenSensorME2O2F20 = () => (
  <board name={"GroveOxygenSensorME2O2F20"} title={"Grove Oxygen Sensor ME2 O2 f20"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
