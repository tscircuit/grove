...
const GroveOxygenSensorME2O2F20 = () => (
  <board name={"GroveOxygenSensorME2O2F20"} title={"Grove Oxygen Sensor ME2 O2 f20"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Oxygen Sensor ME2 O2 f20"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveOxygenSensorME2O2F20 }
export default GroveOxygenSensorME2O2F20
