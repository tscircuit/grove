...
const GroveOLEDDisplay112 = () => (
  <board name={"GroveOLEDDisplay112"} title={"Grove OLED Display 1 12"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
