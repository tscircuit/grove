# DESIGN_REVIEW1 — Grove OLED Display 1 12

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveOLEDDisplay112`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-OLED-Display-1-12.html)

This review is specific to the checked-in [board source](./GroveOLEDDisplay112.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveOLEDDisplay112.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveOLEDDisplay112.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#12039(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12040(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12041(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12042(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12043(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12044(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12045(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12046(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
