# DESIGN_REVIEW1 — Grove - 10A DC Current Sensor (ACS725)

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove10ADCCurrentSensorACS725`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** analog interface · sensor · 5V · primary model `ACS725` · declared MPN `ACS725`
**Upstream reference:** [Seeed source](https://wiki.seeedstudio.com/Grove_Accessories_Intro/)

This review is specific to the checked-in [board source](./Grove10ADCCurrentSensorACS725.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove10ADCCurrentSensorACS725.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove10ADCCurrentSensorACS725.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | ACS725 | ACS725 | SIG, VCC, GND, AUX |
...
- <trace#6634(from:.R1 > .pin1 to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6635(from:.R1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6636(from:.R_STATUS > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
