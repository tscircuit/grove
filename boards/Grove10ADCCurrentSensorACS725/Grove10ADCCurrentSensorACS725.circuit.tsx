...
const Grove10ADCCurrentSensorACS725 = () => (
  <board name={"Grove10ADCCurrentSensorACS725"} title={"Grove - 10A DC Current Sensor (ACS725)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
