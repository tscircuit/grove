...
const GroveRedLEDMatrixWDriver = () => (
  <board name={"GroveRedLEDMatrixWDriver"} title={"Grove - Red LED Matrix w/Driver"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
