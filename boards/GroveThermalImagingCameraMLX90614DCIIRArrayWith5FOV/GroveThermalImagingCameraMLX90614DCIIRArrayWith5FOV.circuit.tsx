...
const GroveThermalImagingCameraMLX90614DCIIRArrayWith5FOV = () => (
  <board name={"GroveThermalImagingCameraMLX90614DCIIRArrayWith5FOV"} title={"Grove Thermal Imaging Camera MLX90614 DCI IR Array with 5 FOV"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
