...
const GroveThermalImagingCameraMLX90614DCIIRArrayWith5FOV = () => (
  <board name={"GroveThermalImagingCameraMLX90614DCIIRArrayWith5FOV"} title={"Grove Thermal Imaging Camera MLX90614 DCI IR Array with 5 FOV"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
...
export { GroveThermalImagingCameraMLX90614DCIIRArrayWith5FOV }
export default GroveThermalImagingCameraMLX90614DCIIRArrayWith5FOV
