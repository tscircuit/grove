# DESIGN_REVIEW1 — Grove RGB LED Stick 20 WS2813 Mini

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveRGBLEDStick20WS2813Mini`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-RGB-LED-Stick-20-WS2813-Mini-p-4271.html)

This review is specific to the checked-in [board source](./GroveRGBLEDStick20WS2813Mini.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveRGBLEDStick20WS2813Mini.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveRGBLEDStick20WS2813Mini.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| Item | Observed value |
| --- | --- |
| Declared board size | 164mm × 20mm |
...
| PIX17 | simple_chip | WS2813 | WS2813 | BI, VCC, DOUT, DIN, GND, BO |
| C17 | simple_capacitor | 100nF | CC0603KRX7R9BB104 | pin1, pin2 |
| PIX18 | simple_chip | WS2813 | WS2813 | BI, VCC, DOUT, DIN, GND, BO |
| C18 | simple_capacitor | 100nF | CC0603KRX7R9BB104 | pin1, pin2 |
| PIX19 | simple_chip | WS2813 | WS2813 | BI, VCC, DOUT, DIN, GND, BO |
| C19 | simple_capacitor | 100nF | CC0603KRX7R9BB104 | pin1, pin2 |
| PIX20 | simple_chip | WS2813 | WS2813 | BI, VCC, DOUT, DIN, GND, BO |
...
- <trace#13984(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13985(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13986(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13987(from:.PIX1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13988(from:.PIX1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13989(from:.PIX1 > .DIN to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13990(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13991(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
