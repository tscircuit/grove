...
const GroveRGBLEDStick20WS2813Mini = () => (
  <board name={"GroveRGBLEDStick20WS2813Mini"} title={"Grove RGB LED Stick 20 WS2813 Mini"} width={"164mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    {Array.from({ length: 20 }, (_, index) => {
      ...
      return <Fragment key={name}>
        ...
        <capacitor name={`C${index + 1}`} capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" supplierPartNumbers={{ jlcpcb: ["C14663"] }} footprint="0603" connections={{ pin1: "net.VCC", pin2: "net.GND" }} maxDecouplingTraceLength={328 + "mm"} pcbX={capX} pcbY={capY} schX={-7.8 + index * 2.2} schY={4} schOrientation="vertical" />
      </Fragment>
    })}
    ...
    <silkscreentext text={"RGB LED Stick 20 WS2813 Mini"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveRGBLEDStick20WS2813Mini }
export default GroveRGBLEDStick20WS2813Mini
