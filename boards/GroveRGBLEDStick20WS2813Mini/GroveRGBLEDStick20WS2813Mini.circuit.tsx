...
const GroveRGBLEDStick20WS2813Mini = () => (
  <board name={"GroveRGBLEDStick20WS2813Mini"} title={"Grove RGB LED Stick 20 WS2813 Mini"} width={"134mm"} height={"16mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <net name="EMITTER" />
    <net name="LOAD_NEG" />
    <GroveMountingHoles x={63} y={7} />
    <GroveConnector kind="analog" powerVoltage={"5V"} connectToNets pcbX={-61} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
    {Array.from({ length: 20 }, (_, index) => {
      ...
      return <Fragment key={name}>
        ...
        <capacitor name={`C${index + 1}`} capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" footprint="0603" maxDecouplingTraceLength={268 + "mm"} connections={{ pin1: "net.VCC", pin2: "net.GND" }} pcbX={capX} pcbY={capY} schX={-7.8 + index * 2.2} schY={4} schOrientation="vertical" />
      </Fragment>
    })}
    ...
    <silkscreentext text={"RGB LED Stick 20 WS2813 Mini"} pcbX={0} pcbY={6.5} fontSize="0.6mm" />
