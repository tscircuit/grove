...
| PIX21 | simple_chip | WS2813 | WS2813 | DIN, DOUT, VCC, GND |
| C21 | simple_capacitor | 100nF | CC0603KRX7R9BB104 | pin1, pin2 |
| PIX22 | simple_chip | WS2813 | WS2813 | DIN, DOUT, VCC, GND |
| C22 | simple_capacitor | 100nF | CC0603KRX7R9BB104 | pin1, pin2 |
| PIX23 | simple_chip | WS2813 | WS2813 | DIN, DOUT, VCC, GND |
| C23 | simple_capacitor | 100nF | CC0603KRX7R9BB104 | pin1, pin2 |
| PIX24 | simple_chip | WS2813 | WS2813 | DIN, DOUT, VCC, GND |
...
The latest generated artifacts report 0 autorouting error(s), 0 disconnected-port error(s), 0 missing-PCB-trace error(s), 0 source-pin-missing-trace warning(s), 100 unnamed-trace warning(s), 0 refdes warning(s), 0 power metadata warning(s), and 0 ground metadata warning(s).

### Diagnostic sample

- <trace#10672(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10673(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10674(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10675(from:.PIX1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10676(from:.PIX1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10677(from:.PIX1 > .DIN to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10678(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10679(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
