...
| PIX21 | simple_chip | WS2813 | WS2813 | BI, VCC, DOUT, DIN, GND, BO |
| C21 | simple_capacitor | 100nF | CC0603KRX7R9BB104 | pin1, pin2 |
| PIX22 | simple_chip | WS2813 | WS2813 | BI, VCC, DOUT, DIN, GND, BO |
| C22 | simple_capacitor | 100nF | CC0603KRX7R9BB104 | pin1, pin2 |
| PIX23 | simple_chip | WS2813 | WS2813 | BI, VCC, DOUT, DIN, GND, BO |
| C23 | simple_capacitor | 100nF | CC0603KRX7R9BB104 | pin1, pin2 |
| PIX24 | simple_chip | WS2813 | WS2813 | BI, VCC, DOUT, DIN, GND, BO |
...
The latest generated artifacts report 0 autorouting error(s), 0 disconnected-port error(s), 0 missing-PCB-trace error(s), 48 source-pin-missing-trace warning(s), 6 unnamed-trace warning(s), 0 refdes warning(s), 23 power metadata warning(s), and 23 ground metadata warning(s).

### Diagnostic sample

- <trace#13160(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13161(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13162(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13163(from:.PIX1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13164(from:.PIX1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#13165(from:.PIX1 > .DIN to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
