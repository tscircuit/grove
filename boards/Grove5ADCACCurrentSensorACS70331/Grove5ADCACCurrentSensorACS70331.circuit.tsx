...
const Grove5ADCACCurrentSensorACS70331 = () => (
  <board name={"Grove5ADCACCurrentSensorACS70331"} title={"Grove - ±5A DC/AC Current Sensor (ACS70331)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
