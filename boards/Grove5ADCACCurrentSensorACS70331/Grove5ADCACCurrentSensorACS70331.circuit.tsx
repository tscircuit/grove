...
const Grove5ADCACCurrentSensorACS70331 = () => (
  <board name={"Grove5ADCACCurrentSensorACS70331"} title={"Grove - ±5A DC/AC Current Sensor (ACS70331)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <trace name="GROUND_RAIL" path={["J1.GND","U1.GND","C1.pin2","R1.pin2","D_STATUS.cathode"]} />
    <trace name="SIGNAL_RAIL" path={["J1.SIG","U1.SIG","R1.pin1"]} />
    <trace name="STATUS_RAIL" path={["R_STATUS.pin2","D_STATUS.anode"]} />
    <silkscreentext text={"±5A DC/AC Current Sensor (ACS70…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { Grove5ADCACCurrentSensorACS70331 }
export default Grove5ADCACCurrentSensorACS70331
