# DESIGN_REVIEW1 — Grove - ±5A DC/AC Current Sensor (ACS70331)

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove5ADCACCurrentSensorACS70331`
...
This review is specific to the checked-in [board source](./Grove5ADCACCurrentSensorACS70331.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove5ADCACCurrentSensorACS70331.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove5ADCACCurrentSensorACS70331.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#21163(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#21164(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#21165(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#21166(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#21167(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#21168(from:.R1 > .pin1 to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#21169(from:.R1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#21170(from:.R_STATUS > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
