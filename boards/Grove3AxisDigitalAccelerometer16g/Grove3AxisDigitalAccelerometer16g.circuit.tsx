...
const Grove3AxisDigitalAccelerometer16g = () => (
  <board name={"Grove3AxisDigitalAccelerometer16g"} title={"Grove 3 Axis Digital Accelerometer 16g"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"3 Axis Digital Accelerometer 16g"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { Grove3AxisDigitalAccelerometer16g }
export default Grove3AxisDigitalAccelerometer16g
