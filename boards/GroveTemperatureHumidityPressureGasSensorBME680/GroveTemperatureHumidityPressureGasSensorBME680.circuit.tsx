...
const GroveTemperatureHumidityPressureGasSensorBME680 = () => (
  <board name={"GroveTemperatureHumidityPressureGasSensorBME680"} title={"Grove - Temperature Humidity Pressure Gas Sensor(BME680)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Temperature Humidity Pressure G…"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveTemperatureHumidityPressureGasSensorBME680 }
