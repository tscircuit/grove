...
const GroveTemperatureHumidityPressureGasSensorBME680 = () => (
  <board name={"GroveTemperatureHumidityPressureGasSensorBME680"} title={"Grove - Temperature Humidity Pressure Gas Sensor(BME680)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
