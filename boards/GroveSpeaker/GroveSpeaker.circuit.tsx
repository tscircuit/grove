...
const GroveSpeaker = () => (
  <board name={"GroveSpeaker"} title={"Grove - Speaker"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
