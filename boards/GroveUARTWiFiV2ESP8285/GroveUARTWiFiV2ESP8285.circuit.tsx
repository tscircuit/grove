...
const GroveUARTWiFiV2ESP8285 = () => (
  <board name={"GroveUARTWiFiV2ESP8285"} title={"Grove UART WiFi V2 ESP8285"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"UART WiFi V2 ESP8285"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveUARTWiFiV2ESP8285 }
export default GroveUARTWiFiV2ESP8285
