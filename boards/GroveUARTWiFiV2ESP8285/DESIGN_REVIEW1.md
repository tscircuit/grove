# DESIGN_REVIEW1 — Grove UART WiFi V2 ESP8285

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveUARTWiFiV2ESP8285`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-UART-WiFi-V2-ESP8285.html)

This review is specific to the checked-in [board source](./GroveUARTWiFiV2ESP8285.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveUARTWiFiV2ESP8285.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveUARTWiFiV2ESP8285.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#19190(from:.J1 > .RX to:net.RX) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19191(from:.J1 > .TX to:net.TX) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19192(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19193(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19194(from:.U1 > .RX to:net.RX_MCU) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19195(from:.U1 > .TX to:net.TX_MCU) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19196(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#19197(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
