...
const GroveTemperatureHumiditySensorDHT11 = () => (
  <board name={"GroveTemperatureHumiditySensorDHT11"} title={"Grove - Temperature&Humidity Sensor (DHT11)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Temperature&Humidity Sensor (DH…"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveTemperatureHumiditySensorDHT11 }
