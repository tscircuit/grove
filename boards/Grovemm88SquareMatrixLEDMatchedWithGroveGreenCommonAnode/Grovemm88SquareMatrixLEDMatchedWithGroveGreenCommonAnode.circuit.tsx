...
const Grovemm88SquareMatrixLEDMatchedWithGroveGreenCommonAnode = () => (
  <board name={"Grovemm88SquareMatrixLEDMatchedWithGroveGreenCommonAnode"} title={"38mm 8 8 square matrix LED matched with Grove Green Common Anode"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
