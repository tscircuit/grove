# DESIGN_REVIEW1 — 38mm 8 8 square matrix LED matched with Grove Green Common Anode

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grovemm88SquareMatrixLEDMatchedWithGroveGreenCommonAnode`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/38mm-8-8-square-matrix-LED-matched-with-Grove-Green-Common-Anode-p-4050.html)

This review is specific to the checked-in [board source](./Grovemm88SquareMatrixLEDMatchedWithGroveGreenCommonAnode.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grovemm88SquareMatrixLEDMatchedWithGroveGreenCommonAnode.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grovemm88SquareMatrixLEDMatchedWithGroveGreenCommonAnode.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#9968(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9969(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9970(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9971(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9972(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9973(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9974(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9975(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
