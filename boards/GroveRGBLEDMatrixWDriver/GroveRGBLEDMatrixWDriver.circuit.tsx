...
const GroveRGBLEDMatrixWDriver = () => (
  <board name={"GroveRGBLEDMatrixWDriver"} title={"Grove - RGB LED Matrix w/Driver"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
