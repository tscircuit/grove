# DESIGN_REVIEW1 — Grove Triple Color E Ink Display 2 13

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveTripleColorEInkDisplay213`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** i2c interface · display · 5V · primary model `IL0373` · declared MPN `IL0373`
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Triple-Color-E-Ink-Display-2-13-p-2889.html)

This review is specific to the checked-in [board source](./GroveTripleColorEInkDisplay213.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveTripleColorEInkDisplay213.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveTripleColorEInkDisplay213.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | IL0373 | IL0373 | SDA, SCL, VCC, GND, ADDR, INT |
...
| U3 | simple_chip | IL0373 display panel | IL0373 | VCC, GND, SCL, SDA |
...
- <trace#18766(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18767(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18768(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18769(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18770(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18771(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18772(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#18773(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
