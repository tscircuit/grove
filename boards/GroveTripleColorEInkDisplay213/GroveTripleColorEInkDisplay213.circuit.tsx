...
const GroveTripleColorEInkDisplay213 = () => (
  <board name={"GroveTripleColorEInkDisplay213"} title={"Grove Triple Color E Ink Display 2 13"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
