...
const GroveTripleColorEInkDisplay213 = () => (
  <board name={"GroveTripleColorEInkDisplay213"} title={"Grove Triple Color E Ink Display 2 13"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Triple Color E Ink Display 2 13"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveTripleColorEInkDisplay213 }
export default GroveTripleColorEInkDisplay213
