...
const GroveAHT20I2CIndustrialGradeTemperatureHumiditySensor = () => (
  <board name={"GroveAHT20I2CIndustrialGradeTemperatureHumiditySensor"} title={"Grove - AHT20 I2C Industrial Grade Temperature&Humidity Sensor"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <capacitor name="C_ENVIRONMENTAL" capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" footprint="0603" maxDecouplingTraceLength="100mm" connections={{ pin1: "net.VDD", pin2: "net.GND" }} pcbX={10} pcbY={8} schX={8} schY={4} schOrientation="vertical" />
