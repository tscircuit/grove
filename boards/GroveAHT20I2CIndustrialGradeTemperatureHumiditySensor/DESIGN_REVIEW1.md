# DESIGN_REVIEW1 — Grove - AHT20 I2C Industrial Grade Temperature&Humidity Sensor

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveAHT20I2CIndustrialGradeTemperatureHumiditySensor`
...
This review is specific to the checked-in [board source](./GroveAHT20I2CIndustrialGradeTemperatureHumiditySensor.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveAHT20I2CIndustrialGradeTemperatureHumiditySensor.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveAHT20I2CIndustrialGradeTemperatureHumiditySensor.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#4056(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4057(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4058(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4059(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4060(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4061(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4062(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4063(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
