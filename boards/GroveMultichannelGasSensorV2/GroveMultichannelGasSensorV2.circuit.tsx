...
const GroveMultichannelGasSensorV2 = () => (
  <board name={"GroveMultichannelGasSensorV2"} title={"Grove Multichannel Gas Sensor v2"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
