...
const GroveMultichannelGasSensorV2 = () => (
  <board name={"GroveMultichannelGasSensorV2"} title={"Grove Multichannel Gas Sensor v2"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Multichannel Gas Sensor v2"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveMultichannelGasSensorV2 }
export default GroveMultichannelGasSensorV2
