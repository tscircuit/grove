...
const GroveOfflineVoiceRecognition = () => (
  <board name={"GroveOfflineVoiceRecognition"} title={"Grove Offline Voice Recognition"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <GroveConnector kind="uart" powerVoltage={"5V"} pcbX={-14} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
