...
const Grove3AxisDigitalAccelerometerLIS3DHTR = () => (
  <board name={"Grove3AxisDigitalAccelerometerLIS3DHTR"} title={"Grove - 3-Axis Digital Accelerometer (LIS3DHTR)"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
