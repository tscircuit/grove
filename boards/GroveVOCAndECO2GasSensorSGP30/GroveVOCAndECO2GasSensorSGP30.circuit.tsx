...
const GroveVOCAndECO2GasSensorSGP30 = () => (
  <board name={"GroveVOCAndECO2GasSensorSGP30"} title={"Grove-VOC and eCO2 Gas Sensor(SGP30)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
