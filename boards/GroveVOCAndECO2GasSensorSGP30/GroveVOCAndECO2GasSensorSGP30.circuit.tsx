...
const GroveVOCAndECO2GasSensorSGP30 = () => (
  <board name={"GroveVOCAndECO2GasSensorSGP30"} title={"Grove-VOC and eCO2 Gas Sensor(SGP30)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"VOC and eCO2 Gas Sensor(SGP30)"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveVOCAndECO2GasSensorSGP30 }
export default GroveVOCAndECO2GasSensorSGP30
