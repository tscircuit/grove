...
const GroveCapacitiveTouchSliderSensorCY8C4014LQI = () => (
  <board name={"GroveCapacitiveTouchSliderSensorCY8C4014LQI"} title={"Grove Capacitive Touch Slider Sensor CY8C4014LQI"} width={"40mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Capacitive Touch Slider Sensor…"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveCapacitiveTouchSliderSensorCY8C4014LQI }
export default GroveCapacitiveTouchSliderSensorCY8C4014LQI
