...
const GroveCapacitiveTouchSliderSensorCY8C4014LQI = () => (
  <board name={"GroveCapacitiveTouchSliderSensorCY8C4014LQI"} title={"Grove Capacitive Touch Slider Sensor CY8C4014LQI"} width={"42mm"} height={"32mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <silkscreentext text={"Capacitive Touch Slider Sensor…"} pcbX={0} pcbY={14.5} fontSize="0.6mm" />
