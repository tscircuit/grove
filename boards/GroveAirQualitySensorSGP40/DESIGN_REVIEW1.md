# DESIGN_REVIEW1 — Grove Air Quality Sensor SGP40

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveAirQualitySensorSGP40`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Air-Quality-Sensor-SGP40-p-5700.html)

This review is specific to the checked-in [board source](./GroveAirQualitySensorSGP40.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveAirQualitySensorSGP40.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveAirQualitySensorSGP40.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- Footprint strings declared in source: `jlcpcb:C2874215`, `jlcpcb:C131334`, `jlcpcb:C14663`, `jlcpcb:C5446`, `jlcpcb:C15849`, `sot23`, `0603`.
...
- <trace#4469(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4470(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4471(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4472(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4473(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4474(from:.U1 > .VSS to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4475(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#4476(from:.U1 > .VDDH to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
