...
const GroveAirQualitySensorSGP40 = () => (
  <board name={"GroveAirQualitySensorSGP40"} title={"Grove Air Quality Sensor SGP40"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
