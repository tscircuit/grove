# Grove Air Quality Sensor SGP40

Detailed Grove **Sensor** board model with a SGP40 controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `i2c`
- Board family: `sensor`
- Primary part: `SGP40` (MPN: `SGP40`)
- Power rail: `5V`
- Source: [Seeed Studio catalogue or Grove guide](https://www.seeedstudio.com/Grove-Air-Quality-Sensor-SGP40-p-5700.html)
