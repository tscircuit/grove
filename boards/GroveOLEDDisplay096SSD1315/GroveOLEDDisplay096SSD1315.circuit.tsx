...
const GroveOLEDDisplay096SSD1315 = () => (
  <board name={"GroveOLEDDisplay096SSD1315"} title={"Grove - OLED Display 0.96\" (SSD1315)"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
