...
const GroveCarbonDioxideSensorMHZ16 = () => (
  <board name={"GroveCarbonDioxideSensorMHZ16"} title={"Grove Carbon Dioxide Sensor MH Z16"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Carbon Dioxide Sensor MH Z16"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveCarbonDioxideSensorMHZ16 }
export default GroveCarbonDioxideSensorMHZ16
