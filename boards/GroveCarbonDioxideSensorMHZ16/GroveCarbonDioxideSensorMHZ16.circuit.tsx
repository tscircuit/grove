...
const GroveCarbonDioxideSensorMHZ16 = () => (
  <board name={"GroveCarbonDioxideSensorMHZ16"} title={"Grove Carbon Dioxide Sensor MH Z16"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
