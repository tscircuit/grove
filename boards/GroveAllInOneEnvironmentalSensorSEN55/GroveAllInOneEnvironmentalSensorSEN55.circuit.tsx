...
const GroveAllInOneEnvironmentalSensorSEN55 = () => (
  <board name={"GroveAllInOneEnvironmentalSensorSEN55"} title={"Grove All in one Environmental Sensor SEN55"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
