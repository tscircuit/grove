...
const GroveAllInOneEnvironmentalSensorSEN55 = () => (
  <board name={"GroveAllInOneEnvironmentalSensorSEN55"} title={"Grove All in one Environmental Sensor SEN55"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
...
export { GroveAllInOneEnvironmentalSensorSEN55 }
export default GroveAllInOneEnvironmentalSensorSEN55
