...
const GroveOLEDDisplay066SSD1306V10 = () => (
  <board name={"GroveOLEDDisplay066SSD1306V10"} title={"Grove OLED Display 0 66 SSD1306 v1 0"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
