...
| U1 | simple_chip | SSD1306 | SSD1306 | SDA, SCL, VCC, GND, ADDR, INT, pin7, pin8 |
...
| DISP1 | simple_chip | SSD1306 display panel | UNSPECIFIED-DISPLAY-GroveOLEDDisplay066SSD1306V10 | VCC, GND, DATA |
...
- <trace#81774(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#81775(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#81776(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#81777(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#81778(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#81779(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#81780(from:.R1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
