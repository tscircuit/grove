...
const GroveLightSensorPV11 = () => (
  <board name={"GroveLightSensorPV11"} title={"Grove Light Sensor P v1 1"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Light Sensor P v1 1"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveLightSensorPV11 }
export default GroveLightSensorPV11
