# DESIGN_REVIEW1 — Grove Light Sensor P v1 1

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveLightSensorPV11`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Light-Sensor-P-v1-1.html)

This review is specific to the checked-in [board source](./GroveLightSensorPV11.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveLightSensorPV11.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveLightSensorPV11.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#9367(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9368(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9369(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9370(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9371(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9372(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9373(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#9374(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
