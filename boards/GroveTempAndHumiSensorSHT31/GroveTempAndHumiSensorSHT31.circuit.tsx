...
const GroveTempAndHumiSensorSHT31 = () => (
  <board name={"GroveTempAndHumiSensorSHT31"} title={"Grove - Temp and Humi Sensor(SHT31)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
