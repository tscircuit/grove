...
const GroveVOCGasSensorSGP40 = () => (
  <board name={"GroveVOCGasSensorSGP40"} title={"Grove - VOC Gas Sensor (SGP40)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    {/* JLCPCB footprint imports: footprint="jlcpcb:C2874215", footprint="jlcpcb:C131334", footprint="jlcpcb:C14663" */}
    <GroveConnector kind="i2c" powerVoltage={"5V"} connectToNets pcbX={-24} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
    {/* JLCPCB footprint import: footprint="jlcpcb:C2874215" */}
    ...
    <resistor name="R_HEAT" resistance="33" tolerance="5%" manufacturerPartNumber="RC1206JR-0733RL" supplierPartNumbers={{ jlcpcb: ["C2907384"] }} footprint="1206" connections={{ pin1: "net.VDD", pin2: "net.GND" }} pcbX={10} pcbY={-5} schX={8} schY={-5} />
