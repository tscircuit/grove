# DESIGN_REVIEW1 — Grove - VOC Gas Sensor (SGP40)

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveVOCGasSensorSGP40`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** i2c interface · sensor · 5V · primary model `SGP40` · declared MPN `SGP40`
**Upstream reference:** [Seeed source](https://wiki.seeedstudio.com/Grove_Sensor_Intro/)

This review is specific to the checked-in [board source](./GroveVOCGasSensorSGP40.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveVOCGasSensorSGP40.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveVOCGasSensorSGP40.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | SGP40 | SGP40 | VDD, VSS, SDA, NC, VDDH, SCL, GND |
...
- Footprint strings declared in source: `jlcpcb:C2874215`, `jlcpcb:C131334`, `jlcpcb:C14663`, `jlcpcb:C5446`, `jlcpcb:C15849`, `sot23`, `0603`, `1206`.
...
- <trace#20046(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20047(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20048(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20049(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20050(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20051(from:.U1 > .VSS to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20052(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20053(from:.U1 > .VDDH to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
