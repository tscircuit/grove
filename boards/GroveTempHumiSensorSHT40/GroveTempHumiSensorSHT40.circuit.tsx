...
const GroveTempHumiSensorSHT40 = () => (
  <board name={"GroveTempHumiSensorSHT40"} title={"Grove Temp Humi Sensor SHT40"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
