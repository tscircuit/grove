...
- <trace#32739(from:.U2 > .P12 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#32740(from:.U2 > .P15 to:net.LED) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#32741(from:.U2 > .P9 to:net.VCC_3V3) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#32742(from:.U2 > .P2 to:net.TXD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#32743(from:.U2 > .P4 to:net.RXD) /> is missing a name. Add a name prop to make the trace easier to identify.
