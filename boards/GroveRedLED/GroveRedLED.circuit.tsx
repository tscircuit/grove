...
const GroveRedLED = () => (
  <board name={"GroveRedLED"} title={"Grove - Red LED"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Red LED"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
