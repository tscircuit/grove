...
const GroveSolidStateRelay = () => (
  <board name={"GroveSolidStateRelay"} title={"Grove Solid State Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
