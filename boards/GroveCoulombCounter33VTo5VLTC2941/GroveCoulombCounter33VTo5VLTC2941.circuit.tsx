...
const GroveCoulombCounter33VTo5VLTC2941 = () => (
  <board name={"GroveCoulombCounter33VTo5VLTC2941"} title={"Grove - Coulomb Counter 3.3V to 5V (LTC2941)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <GroveConnector kind="digital" powerVoltage={"3.3V"} pcbX={-14} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
