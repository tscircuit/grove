...
const GroveCoulombCounter33VTo5VLTC2941 = () => (
  <board name={"GroveCoulombCounter33VTo5VLTC2941"} title={"Grove - Coulomb Counter 3.3V to 5V (LTC2941)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <trace name="POWER_RAIL" path={["J1.VCC","U1.VCC","C1.pin1","R_STATUS.pin1"]} />
    <trace name="GROUND_RAIL" path={["J1.GND","U1.GND","C1.pin2","D_STATUS.cathode"]} />
    <trace name="SIGNAL_RAIL" path={["J1.SIG","U1.SIG"]} />
    <trace name="STATUS_RAIL" path={["R_STATUS.pin2","D_STATUS.anode"]} />
    <silkscreentext text={"Coulomb Counter 3.3V to 5V (LTC…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveCoulombCounter33VTo5VLTC2941 }
export default GroveCoulombCounter33VTo5VLTC2941
