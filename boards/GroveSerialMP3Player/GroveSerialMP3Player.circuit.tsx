...
const GroveSerialMP3Player = () => (
  <board name={"GroveSerialMP3Player"} title={"Grove Serial MP3 Player"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Serial MP3 Player"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveSerialMP3Player }
export default GroveSerialMP3Player
