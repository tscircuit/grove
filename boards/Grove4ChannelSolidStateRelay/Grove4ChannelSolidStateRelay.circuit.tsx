...
const Grove4ChannelSolidStateRelay = () => (
  <board name={"Grove4ChannelSolidStateRelay"} title={"Grove 4 Channel Solid State Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
