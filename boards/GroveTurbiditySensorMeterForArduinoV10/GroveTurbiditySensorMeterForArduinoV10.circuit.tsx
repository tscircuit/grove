...
const GroveTurbiditySensorMeterForArduinoV10 = () => (
  <board name={"GroveTurbiditySensorMeterForArduinoV10"} title={"Grove - Turbidity Sensor Meter for Arduino V1.0"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
