...
const GroveTurbiditySensorMeterForArduinoV10 = () => (
  <board name={"GroveTurbiditySensorMeterForArduinoV10"} title={"Grove - Turbidity Sensor Meter for Arduino V1.0"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Turbidity Sensor Meter for Ardu…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveTurbiditySensorMeterForArduinoV10 }
export default GroveTurbiditySensorMeterForArduinoV10
