...
const GroveDS1307RTCRealTimeClockForArduino = () => (
  <board name={"GroveDS1307RTCRealTimeClockForArduino"} title={"Grove - DS1307 RTC (Real Time Clock) for Arduino"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
