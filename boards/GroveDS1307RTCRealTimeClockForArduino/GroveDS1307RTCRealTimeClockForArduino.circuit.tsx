...
const GroveDS1307RTCRealTimeClockForArduino = () => (
  <board name={"GroveDS1307RTCRealTimeClockForArduino"} title={"Grove - DS1307 RTC (Real Time Clock) for Arduino"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    {/* JLCPCB footprint imports: footprint="jlcpcb:C18723598", footprint="jlcpcb:C131334", footprint="jlcpcb:C14663" */}
    <GroveConnector kind="i2c" powerVoltage={"5V"} connectToNets pcbX={-14} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
    {/* JLCPCB footprint import: footprint="jlcpcb:C18723598" */}
    ...
    <silkscreentext text={"DS1307 RTC (Real Time Clock) fo…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveDS1307RTCRealTimeClockForArduino }
export default GroveDS1307RTCRealTimeClockForArduino
