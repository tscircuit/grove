...
const GroveGasSensorMQ5 = () => (
  <board name={"GroveGasSensorMQ5"} title={"Grove Gas Sensor MQ5"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
