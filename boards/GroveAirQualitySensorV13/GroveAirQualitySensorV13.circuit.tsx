...
const GroveAirQualitySensorV13 = () => (
  <board name={"GroveAirQualitySensorV13"} title={"Grove - Air Quality Sensor v1.3"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
