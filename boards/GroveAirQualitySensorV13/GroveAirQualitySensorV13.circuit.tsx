...
const GroveAirQualitySensorV13 = () => (
  <board name={"GroveAirQualitySensorV13"} title={"Grove - Air Quality Sensor v1.3"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Air Quality Sensor v1.3"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveAirQualitySensorV13 }
export default GroveAirQualitySensorV13
