...
- The "J" prefix is being used with a <chip />, try using it with a <connector /> or <jumper />
- The "J" prefix is being used with a <chip />, try using it with a <connector /> or <jumper />
- <trace#66646(from:.U1 > .P11 to:net.LED_10) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#66647(from:.U1 > .P12 to:net.LED_9) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#66648(from:.U1 > .P16 to:net.LED_5) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#66649(from:.U1 > .P15 to:net.LED_6) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#66650(from:.U1 > .P14 to:net.LED_7) /> is missing a name. Add a name prop to make the trace easier to identify.
