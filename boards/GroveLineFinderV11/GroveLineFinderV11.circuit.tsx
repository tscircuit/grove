...
const GroveLineFinderV11 = () => (
  <board name={"GroveLineFinderV11"} title={"Grove - Line Finder V1.1"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Line Finder V1.1"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveLineFinderV11 }
export default GroveLineFinderV11
