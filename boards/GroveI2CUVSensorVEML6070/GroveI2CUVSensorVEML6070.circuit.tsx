...
const GroveI2CUVSensorVEML6070 = () => (
  <board name={"GroveI2CUVSensorVEML6070"} title={"Grove I2C UV Sensor VEML6070"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
