...
const GroveI2CUVSensorVEML6070 = () => (
  <board name={"GroveI2CUVSensorVEML6070"} title={"Grove I2C UV Sensor VEML6070"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"I2C UV Sensor VEML6070"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveI2CUVSensorVEML6070 }
export default GroveI2CUVSensorVEML6070
