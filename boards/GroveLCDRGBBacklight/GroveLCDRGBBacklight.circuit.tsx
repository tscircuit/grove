...
const GroveLCDRGBBacklight = () => (
  <board name={"GroveLCDRGBBacklight"} title={"Grove - LCD RGB Backlight"} width={"80mm"} height={"36mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"LCD RGB Backlight"} pcbX={0} pcbY={16.5} fontSize="0.6mm" />
