...
const GroveLCDRGBBacklight = () => (
  <board name={"GroveLCDRGBBacklight"} title={"Grove - LCD RGB Backlight"} width={"80mm"} height={"36mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
