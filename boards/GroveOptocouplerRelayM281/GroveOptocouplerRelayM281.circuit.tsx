...
const GroveOptocouplerRelayM281 = () => (
  <board name={"GroveOptocouplerRelayM281"} title={"Grove - Optocoupler Relay (M281)"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
