...
const GroveOptocouplerRelayM281 = () => (
  <board name={"GroveOptocouplerRelayM281"} title={"Grove - Optocoupler Relay (M281)"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Optocoupler Relay (M281)"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { GroveOptocouplerRelayM281 }
export default GroveOptocouplerRelayM281
