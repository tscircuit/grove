...
const GroveI2CMotorDriverV13 = () => (
  <board name={"GroveI2CMotorDriverV13"} title={"Grove - I2C Motor Driver V1.3"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"I2C Motor Driver V1.3"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { GroveI2CMotorDriverV13 }
