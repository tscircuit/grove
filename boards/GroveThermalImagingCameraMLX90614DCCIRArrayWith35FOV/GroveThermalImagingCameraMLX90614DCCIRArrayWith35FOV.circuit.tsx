...
const GroveThermalImagingCameraMLX90614DCCIRArrayWith35FOV = () => (
  <board name={"GroveThermalImagingCameraMLX90614DCCIRArrayWith35FOV"} title={"Grove Thermal Imaging Camera MLX90614 DCC IR Array with 35 FOV"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Thermal Imaging Camera MLX90614…"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveThermalImagingCameraMLX90614DCCIRArrayWith35FOV }
export default GroveThermalImagingCameraMLX90614DCCIRArrayWith35FOV
