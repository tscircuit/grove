...
const GroveThermalImagingCameraMLX90614DCCIRArrayWith35FOV = () => (
  <board name={"GroveThermalImagingCameraMLX90614DCCIRArrayWith35FOV"} title={"Grove Thermal Imaging Camera MLX90614 DCC IR Array with 35 FOV"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
