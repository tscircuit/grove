# DESIGN_REVIEW1 — Grove Thermal Imaging Camera MLX90614 DCC IR Array with 35 FOV

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveThermalImagingCameraMLX90614DCCIRArrayWith35FOV`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** i2c interface · communications · 5V · primary model `MLX90614` · declared MPN `MLX90614`
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Thermal-Imaging-Camera-MLX90614-DCC-IR-Array-with-35-FOV-p-4657.html)

This review is specific to the checked-in [board source](./GroveThermalImagingCameraMLX90614DCCIRArrayWith35FOV.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveThermalImagingCameraMLX90614DCCIRArrayWith35FOV.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveThermalImagingCameraMLX90614DCCIRArrayWith35FOV.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | MLX90614 | MLX90614 | SCL, SDA, VDD, VSS |
...
- Footprint strings declared in source: `jlcpcb:C490604`, `jlcpcb:C131334`, `jlcpcb:C14663`, `jlcpcb:C5446`, `jlcpcb:C15849`, `sot23`, `0603`.
...
- <trace#14821(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14822(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14823(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14824(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14825(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14826(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14827(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#14828(from:.U1 > .VSS to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
