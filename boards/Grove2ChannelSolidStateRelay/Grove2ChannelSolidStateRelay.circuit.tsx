...
const Grove2ChannelSolidStateRelay = () => (
  <board name={"Grove2ChannelSolidStateRelay"} title={"Grove 2 Channel Solid State Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
