...
const GroveOLEDDisplay096 = () => (
  <board name={"GroveOLEDDisplay096"} title={"Grove OLED Display 0 96"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
