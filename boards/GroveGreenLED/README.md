...
Detailed Grove **Light & LED** board model with a Grove GreenLED controller controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `analog`
- Board family: `actuator`
- Primary part: `Grove GreenLED controller` (MPN: `GROVE-GROVEGREENLED`)
- Power rail: `5V`
- Source: [Seeed Studio catalogue or Grove guide](https://www.seeedstudio.com/Grove-Green-LED.html)
