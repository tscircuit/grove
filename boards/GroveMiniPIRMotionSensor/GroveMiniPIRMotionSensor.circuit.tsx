...
const GroveMiniPIRMotionSensor = () => (
  <board name={"GroveMiniPIRMotionSensor"} title={"Grove mini PIR motion sensor"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"mini PIR motion sensor"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { GroveMiniPIRMotionSensor }
export default GroveMiniPIRMotionSensor
