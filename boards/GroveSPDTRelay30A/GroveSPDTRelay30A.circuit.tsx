...
const GroveSPDTRelay30A = () => (
  <board name={"GroveSPDTRelay30A"} title={"Grove - SPDT Relay(30A)"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
