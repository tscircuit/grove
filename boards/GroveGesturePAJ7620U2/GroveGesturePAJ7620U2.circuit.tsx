...
const GroveGesturePAJ7620U2 = () => (
  <board name={"GroveGesturePAJ7620U2"} title={"Grove Gesture PAJ7620U2"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Gesture PAJ7620U2"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveGesturePAJ7620U2 }
export default GroveGesturePAJ7620U2
