...
const GroveSpeakerPlus = () => (
  <board name={"GroveSpeakerPlus"} title={"Grove - Speaker Plus"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
