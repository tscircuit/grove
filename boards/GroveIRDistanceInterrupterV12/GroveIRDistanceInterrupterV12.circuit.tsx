...
const GroveIRDistanceInterrupterV12 = () => (
  <board name={"GroveIRDistanceInterrupterV12"} title={"Grove - IR Distance Interrupter v1.2"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"IR Distance Interrupter v1.2"} pcbX={0} pcbY={11.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-11.5} fontSize="0.45mm" />
  </board>
)

export { GroveIRDistanceInterrupterV12 }
export default GroveIRDistanceInterrupterV12
