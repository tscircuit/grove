...
const GroveIRDistanceInterrupterV12 = () => (
  <board name={"GroveIRDistanceInterrupterV12"} title={"Grove - IR Distance Interrupter v1.2"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
