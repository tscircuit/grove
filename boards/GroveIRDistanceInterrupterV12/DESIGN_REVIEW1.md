# DESIGN_REVIEW1 — Grove - IR Distance Interrupter v1.2

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveIRDistanceInterrupterV12`
...
This review is specific to the checked-in [board source](./GroveIRDistanceInterrupterV12.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveIRDistanceInterrupterV12.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveIRDistanceInterrupterV12.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#5991(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5992(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5993(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5994(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5995(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5996(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5997(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5998(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
