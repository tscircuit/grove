...
const GroveIMU9DOF = () => (
  <board name={"GroveIMU9DOF"} title={"Grove IMU 9DOF"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
