...
const GroveIMU9DOF = () => (
  <board name={"GroveIMU9DOF"} title={"Grove IMU 9DOF"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"IMU 9DOF"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { GroveIMU9DOF }
export default GroveIMU9DOF
