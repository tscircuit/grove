...
const GroveRotaryAngleSensorP = () => (
  <board name={"GroveRotaryAngleSensorP"} title={"Grove Rotary Angle Sensor P"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Rotary Angle Sensor P"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveRotaryAngleSensorP }
export default GroveRotaryAngleSensorP
