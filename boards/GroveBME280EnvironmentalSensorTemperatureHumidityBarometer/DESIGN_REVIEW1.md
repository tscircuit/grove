...
- Footprint strings declared in source: `jlcpcb:C92489`, `sot23`, `0603`.
...
The latest generated artifacts report 2 autorouting error(s), 11 disconnected-port error(s), 11 missing-PCB-trace error(s), 20 source-pin-missing-trace warning(s), 19 unnamed-trace warning(s), 0 refdes warning(s), 0 power metadata warning(s), and 0 ground metadata warning(s).
...
- Port GND1 on U1 is missing a trace
- Port VDDIO on U1 is missing a trace
- Port GND2 on U1 is missing a trace
