...
const GroveBME280EnvironmentalSensorTemperatureHumidityBarometer = () => (
  <board name={"GroveBME280EnvironmentalSensorTemperatureHumidityBarometer"} title={"Grove BME280 Environmental Sensor Temperature Humidity Barometer"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
