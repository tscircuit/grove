...
const GroveDifferentialAmplifier = () => (
  <board name={"GroveDifferentialAmplifier"} title={"Grove Differential Amplifier"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
