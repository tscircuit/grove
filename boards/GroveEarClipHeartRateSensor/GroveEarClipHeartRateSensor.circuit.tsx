...
const GroveEarClipHeartRateSensor = () => (
  <board name={"GroveEarClipHeartRateSensor"} title={"Grove - Ear-clip Heart Rate Sensor"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
