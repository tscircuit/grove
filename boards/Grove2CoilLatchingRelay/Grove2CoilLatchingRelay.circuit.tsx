...
const Grove2CoilLatchingRelay = () => (
  <board name={"Grove2CoilLatchingRelay"} title={"Grove - 2-Coil Latching Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
