...
const Grove2CoilLatchingRelay = () => (
  <board name={"Grove2CoilLatchingRelay"} title={"Grove - 2-Coil Latching Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"2-Coil Latching Relay"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { Grove2CoilLatchingRelay }
export default Grove2CoilLatchingRelay
