...
- The "Q" prefix is being used with a <chip />, try using it with a <transistor />
- <trace#70885(from:.J1 > .pin3 to:net.N_V) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#70886(from:.J1 > .pin4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#70887(from:.J1 > .pin2 to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#70888(from:.J1 > .pin1 to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#70889(from:.U1 > .P3 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#70890(from:.U1 > .P2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
