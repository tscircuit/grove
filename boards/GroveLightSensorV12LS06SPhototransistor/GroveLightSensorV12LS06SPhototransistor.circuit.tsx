...
const GroveLightSensorV12LS06SPhototransistor = () => (
  <board name={"GroveLightSensorV12LS06SPhototransistor"} title={"Grove Light Sensor v1 2 LS06 S phototransistor"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
