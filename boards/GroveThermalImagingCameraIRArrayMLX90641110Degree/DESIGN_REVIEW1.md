# DESIGN_REVIEW1 — Grove Thermal Imaging Camera IR Array MLX90641 110 degree

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveThermalImagingCameraIRArrayMLX90641110Degree`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Thermal-Imaging-Camera-IR-Array-MLX90641-110-degree-p-4612.html)

This review is specific to the checked-in [board source](./GroveThermalImagingCameraIRArrayMLX90641110Degree.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveThermalImagingCameraIRArrayMLX90641110Degree.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveThermalImagingCameraIRArrayMLX90641110Degree.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#108821(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108822(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108823(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108824(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108825(from:.U2 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108826(from:.U2 > .VOUT to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108827(from:.U2 > .VIN to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#108828(from:.C2 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
