...
const GroveThermalImagingCameraIRArrayMLX90641110Degree = () => (
  <board name={"GroveThermalImagingCameraIRArrayMLX90641110Degree"} title={"Grove Thermal Imaging Camera IR Array MLX90641 110 degree"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Thermal Imaging Camera IR Array…"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveThermalImagingCameraIRArrayMLX90641110Degree }
export default GroveThermalImagingCameraIRArrayMLX90641110Degree
