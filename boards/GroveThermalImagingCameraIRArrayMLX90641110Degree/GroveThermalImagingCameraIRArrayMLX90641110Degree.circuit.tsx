...
const GroveThermalImagingCameraIRArrayMLX90641110Degree = () => (
  <board name={"GroveThermalImagingCameraIRArrayMLX90641110Degree"} title={"Grove Thermal Imaging Camera IR Array MLX90641 110 degree"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
