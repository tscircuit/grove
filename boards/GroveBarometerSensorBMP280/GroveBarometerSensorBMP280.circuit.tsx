...
const GroveBarometerSensorBMP280 = () => (
  <board name={"GroveBarometerSensorBMP280"} title={"Grove - Barometer Sensor (BMP280)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
