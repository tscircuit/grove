...
const GroveBarometerSensorBMP280 = () => (
  <board name={"GroveBarometerSensorBMP280"} title={"Grove - Barometer Sensor (BMP280)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <chip name="U1" displayName={"BMP280"} manufacturerPartNumber={"BMP280"} supplierPartNumbers={{ jlcpcb: ["C83291"] }} pinLabels={{ pin1: "GND2", pin2: "CSB", pin3: "SDA", pin4: "SCL", pin5: "SDO", pin6: "VDDIO", pin7: "GND1", pin8: "VDD" }} pinAttributes={{ GND2: { requiresGround: true, mustBeConnected: true }, CSB: { doNotConnect: true }, SDA: { mustBeConnected: true, isGpio: true }, SCL: { mustBeConnected: true, isGpio: true }, SDO: { doNotConnect: true }, VDDIO: { requiresPower: true, mustBeConnected: true }, GND1: { requiresGround: true, mustBeConnected: true }, VDD: { requiresPower: true, mustBeConnected: true } }} connections={{ "GND2": "net.GND", "SDA": "net.SDA", "SCL": "net.SCL", "VDDIO": "net.VDD", "GND1": "net.GND", "VDD": "net.VDD" }} noConnect={["CSB", "SDO"]} footprint={<footprint><smtpad shape="rect" width="1mm" height="0.6mm" pcbX={-2.5} pcbY={-1.905} portHints={["pin1"]} /><smtpad shape="rect" width="1mm" height="0.6mm" pcbX={-2.5} pcbY={-0.635} portHints={["pin2"]} /><smtpad shape="rect" width="1mm" height="0.6mm" pcbX={-2.5} pcbY={0.635} portHints={["pin3"]} /><smtpad shape="rect" width="1mm" height="0.6mm" pcbX={-2.5} pcbY={1.905} portHints={["pin4"]} /><smtpad shape="rect" width="1mm" height="0.6mm" pcbX={2.5} pcbY={-1.905} portHints={["pin5"]} /><smtpad shape="rect" width="1mm" height="0.6mm" pcbX={2.5} pcbY={-0.635} portHints={["pin6"]} /><smtpad shape="rect" width="1mm" height="0.6mm" pcbX={2.5} pcbY={0.635} portHints={["pin7"]} /><smtpad shape="rect" width="1mm" height="0.6mm" pcbX={2.5} pcbY={1.905} portHints={["pin8"]} /><silkscreenrect width="4mm" height="6.08mm" stroke="solid" strokeWidth="0.15mm" filled={false} /></footprint>} pcbX={4} pcbY={0} schX={2} schY={0} schWidth="1.6mm" schHeight="0.4mm" schPinArrangement={{ leftSide: ["GND2","CSB","SDA","SCL"], rightSide: ["SDO","VDDIO","GND1","VDD"] }} />
    ...
    <capacitor name="C_ENVIRONMENTAL" capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" footprint="0603" maxDecouplingTraceLength="100mm" connections={{ pin1: "net.VDD", pin2: "net.GND" }} pcbX={7} pcbY={7} schX={8} schY={4} schOrientation="vertical" />
    <trace name="INPUT_RAIL" path={["J1.VCC","U2.VIN","C2.pin1"]} />
    <trace name="REGULATED_RAIL" path={["U2.VOUT","U1.VDDIO","U1.VDD","C1.pin1","R1.pin1","R2.pin1","C_ENVIRONMENTAL.pin1"]} />
    <trace name="GROUND_RAIL" path={["J1.GND","U1.GND2","U1.GND1","U2.GND","C2.pin2","C1.pin2","C_ENVIRONMENTAL.pin2"]} />
    <trace name="I2C_SCL" path={["J1.SCL","U1.SCL","R1.pin2"]} />
    <trace name="I2C_SDA" path={["J1.SDA","U1.SDA","R2.pin2"]} />
    <silkscreentext text={"Barometer Sensor (BMP280)"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveBarometerSensorBMP280 }
