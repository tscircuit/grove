...
const GroveRotaryAngleSensor = () => (
  <board name={"GroveRotaryAngleSensor"} title={"Grove - Rotary Angle Sensor v1.2"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Rotary Angle Sensor v1.2"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveRotaryAngleSensor }
