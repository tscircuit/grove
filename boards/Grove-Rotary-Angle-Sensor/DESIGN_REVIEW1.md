# DESIGN_REVIEW1 — Grove - Rotary Angle Sensor v1.2

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove-Rotary-Angle-Sensor`
...
**Upstream reference:** [Seeed source](https://wiki.seeedstudio.com/Grove-Rotary_Angle_Sensor/)

This review is specific to the checked-in [board source](./Grove-Rotary-Angle-Sensor.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove-Rotary-Angle-Sensor.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove-Rotary-Angle-Sensor.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#390(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#391(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#392(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#393(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#394(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#395(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#396(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#397(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
