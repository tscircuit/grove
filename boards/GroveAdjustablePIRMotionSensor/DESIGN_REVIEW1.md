...
- The "J" prefix is being used with a <chip />, try using it with a <connector /> or <jumper />
- <trace#25153(from:.R1 > .pin1 to:net.D1) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#25154(from:.R1 > .pin2 to:net.N_5) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#25155(from:.C3 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#25156(from:.C3 > .pin1 to:net.N_7) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#25157(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#25158(from:.C1 > .pin1 to:net.N_2) /> is missing a name. Add a name prop to make the trace easier to identify.
