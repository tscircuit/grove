...
Detailed Grove **Display** board model with a Grove 054InchRedAlphanumericDisplay controller controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `i2c`
- Board family: `display`
- Primary part: `Grove 054InchRedAlphanumericDisplay controller` (MPN: `GROVE-GROVE054INCHREDALPHANUMERICDISPLAY`)
- Power rail: `5V`
