...
const GroveChainableRGBLED = () => (
  <board name={"GroveChainableRGBLED"} title={"Grove Chainable RGB LED"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Chainable RGB LED"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveChainableRGBLED }
export default GroveChainableRGBLED
