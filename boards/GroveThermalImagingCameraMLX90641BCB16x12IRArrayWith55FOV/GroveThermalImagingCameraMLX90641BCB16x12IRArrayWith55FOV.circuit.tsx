...
const GroveThermalImagingCameraMLX90641BCB16x12IRArrayWith55FOV = () => (
  <board name={"GroveThermalImagingCameraMLX90641BCB16x12IRArrayWith55FOV"} title={"Grove Thermal Imaging Camera MLX90641 BCB 16x12 IR Array with 55 FOV"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
