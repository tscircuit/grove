...
const GroveThermalImagingCameraMLX90641BCB16x12IRArrayWith55FOV = () => (
  <board name={"GroveThermalImagingCameraMLX90641BCB16x12IRArrayWith55FOV"} title={"Grove Thermal Imaging Camera MLX90641 BCB 16x12 IR Array with 55 FOV"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Thermal Imaging Camera MLX90641…"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveThermalImagingCameraMLX90641BCB16x12IRArrayWith55FOV }
export default GroveThermalImagingCameraMLX90641BCB16x12IRArrayWith55FOV
