...
const GroveRelay2 = () => (
  <board name={"GroveRelay2"} title={"Grove - Relay"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
