...
const GroveTemperatureSensorV12 = () => (
  <board name={"GroveTemperatureSensorV12"} title={"Grove - Temperature Sensor V1.2"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
