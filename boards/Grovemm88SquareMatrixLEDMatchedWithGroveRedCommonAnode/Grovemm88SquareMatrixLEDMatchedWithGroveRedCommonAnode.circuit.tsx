...
const Grovemm88SquareMatrixLEDMatchedWithGroveRedCommonAnode = () => (
  <board name={"Grovemm88SquareMatrixLEDMatchedWithGroveRedCommonAnode"} title={"38mm 8 8 square matrix LED matched with Grove Red Common Anode"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
