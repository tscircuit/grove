# DESIGN_REVIEW1 — 38mm 8 8 square matrix LED matched with Grove Red Common Anode

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grovemm88SquareMatrixLEDMatchedWithGroveRedCommonAnode`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/38mm-8-8-square-matrix-LED-matched-with-Grove-Red-Common-Anode-p-4051.html)

This review is specific to the checked-in [board source](./Grovemm88SquareMatrixLEDMatchedWithGroveRedCommonAnode.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grovemm88SquareMatrixLEDMatchedWithGroveRedCommonAnode.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grovemm88SquareMatrixLEDMatchedWithGroveRedCommonAnode.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#10589(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10590(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10591(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10592(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10593(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10594(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10595(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#10596(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
