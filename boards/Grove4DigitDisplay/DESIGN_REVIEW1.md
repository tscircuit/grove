...
- <trace#20985(from:.J1 > .pin3 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20986(from:.J1 > .pin4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20987(from:.J1 > .pin1 to:net.CLK) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20988(from:.J1 > .pin2 to:net.DIO) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20989(from:.U1 > .P2 to:net.A) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20990(from:.U1 > .P3 to:net.B) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20991(from:.U1 > .P4 to:net.C) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#20992(from:.U1 > .P5 to:net.D) /> is missing a name. Add a name prop to make the trace easier to identify.
