...
const GroveBuzzer = () => (
  <board name={"GroveBuzzer"} title={"Grove - Buzzer v1.1b"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Buzzer v1.1b"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
