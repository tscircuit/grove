...
const GroveHighPrecisionBarometerSensorDPS310 = () => (
  <board name={"GroveHighPrecisionBarometerSensorDPS310"} title={"Grove High Precision Barometer Sensor DPS310"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
