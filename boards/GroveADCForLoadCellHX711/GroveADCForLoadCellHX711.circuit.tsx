...
const GroveADCForLoadCellHX711 = () => (
  <board name={"GroveADCForLoadCellHX711"} title={"Grove - ADC for Load Cell (HX711)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"ADC for Load Cell (HX711)"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveADCForLoadCellHX711 }
export default GroveADCForLoadCellHX711
