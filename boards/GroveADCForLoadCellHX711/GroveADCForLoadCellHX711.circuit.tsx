...
const GroveADCForLoadCellHX711 = () => (
  <board name={"GroveADCForLoadCellHX711"} title={"Grove - ADC for Load Cell (HX711)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
