...
const Grove6AxisAccelerometerGyroscope = () => (
  <board name={"Grove6AxisAccelerometerGyroscope"} title={"Grove - 6-Axis Accelerometer&Gyroscope"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
...
export { Grove6AxisAccelerometerGyroscope }
