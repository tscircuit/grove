...
const GrovePurpleLED3mm = () => (
  <board name={"GrovePurpleLED3mm"} title={"Grove Purple LED 3mm"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Purple LED 3mm"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GrovePurpleLED3mm }
export default GrovePurpleLED3mm
