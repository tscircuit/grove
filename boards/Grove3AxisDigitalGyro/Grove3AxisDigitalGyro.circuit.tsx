...
const Grove3AxisDigitalGyro = () => (
  <board name={"Grove3AxisDigitalGyro"} title={"Grove 3 Axis Digital Gyro"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"3 Axis Digital Gyro"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { Grove3AxisDigitalGyro }
