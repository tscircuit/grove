...
const GroveGasSensorMQ2 = () => (
  <board name={"GroveGasSensorMQ2"} title={"Grove Gas Sensor MQ2"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Gas Sensor MQ2"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveGasSensorMQ2 }
export default GroveGasSensorMQ2
