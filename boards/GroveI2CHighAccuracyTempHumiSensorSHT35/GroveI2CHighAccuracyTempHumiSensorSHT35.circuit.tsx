...
const GroveI2CHighAccuracyTempHumiSensorSHT35 = () => (
  <board name={"GroveI2CHighAccuracyTempHumiSensorSHT35"} title={"Grove - I2C High Accuracy Temp&Humi Sensor(SHT35)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <capacitor name="C_ENVIRONMENTAL" capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" footprint="0603" maxDecouplingTraceLength="100mm" connections={{ pin1: "net.VDD", pin2: "net.GND" }} pcbX={10} pcbY={5} schX={8} schY={4} schOrientation="vertical" />
    ...
    <silkscreentext text={"I2C High Accuracy Temp&Humi Sen…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveI2CHighAccuracyTempHumiSensorSHT35 }
