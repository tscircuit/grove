...
const GroveI2CHighAccuracyTempHumiSensorSHT35 = () => (
  <board name={"GroveI2CHighAccuracyTempHumiSensorSHT35"} title={"Grove - I2C High Accuracy Temp&Humi Sensor(SHT35)"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
