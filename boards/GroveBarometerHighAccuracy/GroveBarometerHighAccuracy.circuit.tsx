...
const GroveBarometerHighAccuracy = () => (
  <board name={"GroveBarometerHighAccuracy"} title={"Grove - Barometer (High-Accuracy)"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
