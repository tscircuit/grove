...
const Grove433MHzSimpleRFLinkKit = () => (
  <board name={"Grove433MHzSimpleRFLinkKit"} title={"Grove - 433MHz Simple RF Link Kit"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
