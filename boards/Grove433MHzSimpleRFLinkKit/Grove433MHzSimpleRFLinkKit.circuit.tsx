...
const Grove433MHzSimpleRFLinkKit = () => (
  <board name={"Grove433MHzSimpleRFLinkKit"} title={"Grove - 433MHz Simple RF Link Kit"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"433MHz Simple RF Link Kit"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { Grove433MHzSimpleRFLinkKit }
export default Grove433MHzSimpleRFLinkKit
