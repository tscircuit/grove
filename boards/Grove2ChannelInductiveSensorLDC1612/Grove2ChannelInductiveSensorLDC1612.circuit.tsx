...
const Grove2ChannelInductiveSensorLDC1612 = () => (
  <board name={"Grove2ChannelInductiveSensorLDC1612"} title={"Grove - 2-Channel Inductive Sensor(LDC1612)"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <GroveConnector kind="digital" powerVoltage={"5V"} pcbX={-9} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
