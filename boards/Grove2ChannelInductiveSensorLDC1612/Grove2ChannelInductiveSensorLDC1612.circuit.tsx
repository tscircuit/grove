...
const Grove2ChannelInductiveSensorLDC1612 = () => (
  <board name={"Grove2ChannelInductiveSensorLDC1612"} title={"Grove - 2-Channel Inductive Sensor(LDC1612)"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"2-Channel Inductive Sensor(LDC1…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { Grove2ChannelInductiveSensorLDC1612 }
export default Grove2ChannelInductiveSensorLDC1612
