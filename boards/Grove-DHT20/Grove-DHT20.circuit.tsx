...
export const GroveDht20 = () => (
  <board name="GroveDht20" title="Grove - Temperature & Humidity Sensor DHT20 v2.1" width="40mm" height="20mm" borderRadius="1mm" solderMaskColor="blue" placementDrcChecksDisabled>
    <GroveMountingHoles x={18} y={8} />
    <GroveConnector kind="i2c" pcbX={-14} pcbY={0} pcbRotation={90} schX={-10} schY={0} />
    <Dht20 />
    <chip name="U1" displayName="XC6206P332MR-G" pinLabels={{ pin1: "GND", pin2: "VOUT", pin3: "VIN" }} footprint="sot23" pcbX={-7} pcbY={0} schX={-5} schY={4} />
