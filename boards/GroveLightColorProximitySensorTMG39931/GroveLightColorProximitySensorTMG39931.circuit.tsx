...
const GroveLightColorProximitySensorTMG39931 = () => (
  <board name={"GroveLightColorProximitySensorTMG39931"} title={"Grove Light Color Proximity Sensor TMG39931"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Light Color Proximity Sensor TM…"} pcbX={0} pcbY={11.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-11.5} fontSize="0.45mm" />
  </board>
)

export { GroveLightColorProximitySensorTMG39931 }
export default GroveLightColorProximitySensorTMG39931
