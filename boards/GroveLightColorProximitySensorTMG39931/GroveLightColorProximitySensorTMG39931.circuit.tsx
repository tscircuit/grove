...
const GroveLightColorProximitySensorTMG39931 = () => (
  <board name={"GroveLightColorProximitySensorTMG39931"} title={"Grove Light Color Proximity Sensor TMG39931"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
