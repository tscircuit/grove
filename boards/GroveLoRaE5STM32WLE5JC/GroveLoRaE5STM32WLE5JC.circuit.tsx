...
const GroveLoRaE5STM32WLE5JC = () => (
  <board name={"GroveLoRaE5STM32WLE5JC"} title={"Grove LoRa E5 STM32WLE5JC"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"LoRa E5 STM32WLE5JC"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveLoRaE5STM32WLE5JC }
export default GroveLoRaE5STM32WLE5JC
