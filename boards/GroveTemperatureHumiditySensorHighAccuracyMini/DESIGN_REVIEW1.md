...
| U2 | simple_chip | DHT11 | DHT11 | P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21, P22, P23, P24, P25 |
...
- The "Q" prefix is being used with a <chip />, try using it with a <transistor />
- <trace#104400(from:.J1 > .pin4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#104401(from:.J1 > .pin2 to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#104402(from:.J1 > .pin1 to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#104403(from:.J1 > .pin3 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#104404(from:.U3 > .P2 to:net.N_V3) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#104405(from:.U3 > .P3 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
