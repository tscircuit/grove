...
const GroveThermalImagingCameraIRArrayMLX9064055Degree = () => (
  <board name={"GroveThermalImagingCameraIRArrayMLX9064055Degree"} title={"Grove Thermal Imaging Camera IR Array MLX90640 55 degree"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
...
export { GroveThermalImagingCameraIRArrayMLX9064055Degree }
export default GroveThermalImagingCameraIRArrayMLX9064055Degree
