...
const GroveThermalImagingCameraIRArrayMLX9064055Degree = () => (
  <board name={"GroveThermalImagingCameraIRArrayMLX9064055Degree"} title={"Grove Thermal Imaging Camera IR Array MLX90640 55 degree"} width={"52mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
