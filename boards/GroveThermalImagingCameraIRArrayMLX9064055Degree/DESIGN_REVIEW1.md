# DESIGN_REVIEW1 — Grove Thermal Imaging Camera IR Array MLX90640 55 degree

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveThermalImagingCameraIRArrayMLX9064055Degree`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Thermal-Imaging-Camera-IR-Array-MLX90640-55-degree-p-4335.html)

This review is specific to the checked-in [board source](./GroveThermalImagingCameraIRArrayMLX9064055Degree.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveThermalImagingCameraIRArrayMLX9064055Degree.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveThermalImagingCameraIRArrayMLX9064055Degree.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#107909(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#107910(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#107911(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#107912(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#107913(from:.U2 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#107914(from:.U2 > .VOUT to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#107915(from:.U2 > .VIN to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#107916(from:.C2 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
