# DESIGN_REVIEW1 — Grove-Mech keycap

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveMechKeycap`
...
This review is specific to the checked-in [board source](./GroveMechKeycap.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveMechKeycap.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveMechKeycap.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#7036(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#7037(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#7038(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#7039(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#7040(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#7041(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#7042(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#7043(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
