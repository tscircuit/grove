...
const GroveMechKeycap = () => (
  <board name={"GroveMechKeycap"} title={"Grove-Mech keycap"} width={"42mm"} height={"32mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <GroveConnector kind="digital" powerVoltage={"5V"} connectToNets pcbX={-15} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
    ...
    <silkscreentext text={"Mech keycap"} pcbX={0} pcbY={14.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-14.5} fontSize="0.45mm" />
  </board>
)

export { GroveMechKeycap }
export default GroveMechKeycap
