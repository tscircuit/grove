# DESIGN_REVIEW1 — Grove Doppler Radar BGT24LTR11

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveDopplerRadarBGT24LTR11`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** digital interface · utility · 5V · primary model `BGT24LTR11` · declared MPN `BGT24LTR11`
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Doppler-Radar-BGT24LTR11-p-4572.html)

This review is specific to the checked-in [board source](./GroveDopplerRadarBGT24LTR11.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveDopplerRadarBGT24LTR11.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveDopplerRadarBGT24LTR11.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | BGT24LTR11 | BGT24LTR11 | SIG, VCC, GND, AUX |
...
- <trace#6184(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6185(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6186(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6187(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6188(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6189(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6190(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#6191(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
