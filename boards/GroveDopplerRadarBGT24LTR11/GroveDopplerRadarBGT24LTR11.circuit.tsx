...
const GroveDopplerRadarBGT24LTR11 = () => (
  <board name={"GroveDopplerRadarBGT24LTR11"} title={"Grove Doppler Radar BGT24LTR11"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
