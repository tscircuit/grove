...
const GroveDopplerRadarBGT24LTR11 = () => (
  <board name={"GroveDopplerRadarBGT24LTR11"} title={"Grove Doppler Radar BGT24LTR11"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Doppler Radar BGT24LTR11"} pcbX={0} pcbY={11.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-11.5} fontSize="0.45mm" />
  </board>
)

export { GroveDopplerRadarBGT24LTR11 }
export default GroveDopplerRadarBGT24LTR11
