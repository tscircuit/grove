# DESIGN_REVIEW1 — Grove Digital PIR Motion Sensor

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveDigitalPIRMotionSensor`
...
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-Digital-PIR-Motion-Sensor-p-4524.html)

This review is specific to the checked-in [board source](./GroveDigitalPIRMotionSensor.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveDigitalPIRMotionSensor.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveDigitalPIRMotionSensor.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#5992(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5993(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5994(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5995(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5996(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5997(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5998(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#5999(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
