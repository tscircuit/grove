...
const GroveGroveRoundForceSensorFSR402 = () => (
  <board name={"GroveGroveRoundForceSensorFSR402"} title={"Grove - Grove - Round Force Sensor FSR402"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
