...
const GroveGroveRoundForceSensorFSR402 = () => (
  <board name={"GroveGroveRoundForceSensorFSR402"} title={"Grove - Grove - Round Force Sensor FSR402"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Grove - Round Force Sensor FSR4…"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveGroveRoundForceSensorFSR402 }
export default GroveGroveRoundForceSensorFSR402
