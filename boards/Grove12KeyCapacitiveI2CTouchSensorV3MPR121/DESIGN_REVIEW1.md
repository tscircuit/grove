# DESIGN_REVIEW1 — Grove - 12 Key Capacitive I2C Touch Sensor V3 (MPR121)

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove12KeyCapacitiveI2CTouchSensorV3MPR121`
...
This review is specific to the checked-in [board source](./Grove12KeyCapacitiveI2CTouchSensorV3MPR121.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove12KeyCapacitiveI2CTouchSensorV3MPR121.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove12KeyCapacitiveI2CTouchSensorV3MPR121.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#1265(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1266(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1267(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1268(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1269(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1270(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1271(from:.U1 > .VSS to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1272(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
