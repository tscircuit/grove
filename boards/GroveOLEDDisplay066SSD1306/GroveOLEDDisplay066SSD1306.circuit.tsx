...
const GroveOLEDDisplay066SSD1306 = () => (
  <board name={"GroveOLEDDisplay066SSD1306"} title={"Grove - OLED Display 0.66\" (SSD1306)"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"OLED Display 0.66\" (SSD1306)"} pcbX={0} pcbY={13.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-13.5} fontSize="0.45mm" />
  </board>
)

export { GroveOLEDDisplay066SSD1306 }
export default GroveOLEDDisplay066SSD1306
