...
const GroveOLEDDisplay066SSD1306 = () => (
  <board name={"GroveOLEDDisplay066SSD1306"} title={"Grove - OLED Display 0.66\" (SSD1306)"} width={"32mm"} height={"30mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
