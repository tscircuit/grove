...
const GroveIMU10DOFV20 = () => (
  <board name={"GroveIMU10DOFV20"} title={"Grove IMU 10DOF v2 0"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
    ...
    <GroveConnector kind="digital" powerVoltage={"5V"} pcbX={-11} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
