...
const GroveIMU10DOFV20 = () => (
  <board name={"GroveIMU10DOFV20"} title={"Grove IMU 10DOF v2 0"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"IMU 10DOF v2 0"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { GroveIMU10DOFV20 }
export default GroveIMU10DOFV20
