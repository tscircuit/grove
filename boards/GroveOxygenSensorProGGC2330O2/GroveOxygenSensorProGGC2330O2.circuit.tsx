...
const GroveOxygenSensorProGGC2330O2 = () => (
  <board name={"GroveOxygenSensorProGGC2330O2"} title={"Grove - Oxygen Sensor Pro(GGC2330-O2)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
