...
const GroveOxygenSensorProGGC2330O2 = () => (
  <board name={"GroveOxygenSensorProGGC2330O2"} title={"Grove - Oxygen Sensor Pro(GGC2330-O2)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Oxygen Sensor Pro(GGC2330-O2)"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveOxygenSensorProGGC2330O2 }
export default GroveOxygenSensorProGGC2330O2
