...
const GroveUltrasonicDistanceSensor = () => (
  <board name={"GroveUltrasonicDistanceSensor"} title={"Grove Ultrasonic Distance Sensor"} width={"40mm"} height={"26mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
