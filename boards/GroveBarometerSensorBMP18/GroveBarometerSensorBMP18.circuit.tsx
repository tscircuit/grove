...
const GroveBarometerSensorBMP18 = () => (
  <board name={"GroveBarometerSensorBMP18"} title={"Grove Barometer Sensor BMP18"} width={"30mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Barometer Sensor BMP18"} pcbX={0} pcbY={10.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-10.5} fontSize="0.45mm" />
  </board>
)

export { GroveBarometerSensorBMP18 }
