...
Detailed Grove **Input** board model with a MPR121 controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `i2c`
- Board family: `input`
- Primary part: `MPR121` (MPN: `MPR121`)
- Power rail: `5V`
- Source: [Seeed Studio catalogue or Grove guide](https://www.seeedstudio.com/Grove-12-Key-Capacitive-I2C-Touch-Sensor-V2-MPR121.html)
