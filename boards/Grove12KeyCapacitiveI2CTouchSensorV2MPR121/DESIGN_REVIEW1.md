# DESIGN_REVIEW1 — Grove 12 Key Capacitive I2C Touch Sensor V2 MPR121

**Disposition:** NOT PRODUCTION READY
**Board directory:** `Grove12KeyCapacitiveI2CTouchSensorV2MPR121`
**Implementation class:** board-local engineering draft
**Catalogue declaration:** i2c interface · input · 5V · primary model `MPR121` · declared MPN `MPR121`
**Upstream reference:** [Seeed source](https://www.seeedstudio.com/Grove-12-Key-Capacitive-I2C-Touch-Sensor-V2-MPR121.html)

This review is specific to the checked-in [board source](./Grove12KeyCapacitiveI2CTouchSensorV2MPR121.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/Grove12KeyCapacitiveI2CTouchSensorV2MPR121.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/Grove12KeyCapacitiveI2CTouchSensorV2MPR121.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
| U1 | simple_chip | MPR121 | MPR121 | IRQ, SCL, SDA, ADDR, VREG, VSS, REXT, ELE0, ELE1, ELE2, ELE3, ELE4, ELE5, ELE6, ELE7, ELE8, ELE9, ELE10, ELE11, VDD |
...
- Footprint strings declared in source: `jlcpcb:C91322`, `jlcpcb:C131334`, `jlcpcb:C14663`, `jlcpcb:C5446`, `jlcpcb:C15849`, `sot23`, `0603`.
...
- <trace#1300(from:.J1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1301(from:.J1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1302(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1303(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1304(from:.U1 > .SCL to:net.SCL) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1305(from:.U1 > .SDA to:net.SDA) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1306(from:.U1 > .VSS to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#1307(from:.U1 > .VDD to:net.VDD) /> is missing a name. Add a name prop to make the trace easier to identify.
