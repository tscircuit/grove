...
const Grove12KeyCapacitiveI2CTouchSensorV2MPR121 = () => (
  <board name={"Grove12KeyCapacitiveI2CTouchSensorV2MPR121"} title={"Grove 12 Key Capacitive I2C Touch Sensor V2 MPR121"} width={"30mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
