...
const Grove12KeyCapacitiveI2CTouchSensorV2MPR121 = () => (
  <board name={"Grove12KeyCapacitiveI2CTouchSensorV2MPR121"} title={"Grove 12 Key Capacitive I2C Touch Sensor V2 MPR121"} width={"40mm"} height={"24mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    {/* JLCPCB footprint imports: footprint="jlcpcb:C91322", footprint="jlcpcb:C131334", footprint="jlcpcb:C14663" */}
    <GroveConnector kind="i2c" powerVoltage={"5V"} connectToNets pcbX={-14} pcbY={0} pcbRotation={-90} schX={-10} schY={0} />
    {/* JLCPCB footprint import: footprint="jlcpcb:C91322" */}
    ...
    <capacitor name="C1" capacitance="100nF" manufacturerPartNumber="CC0603KRX7R9BB104" supplierPartNumbers={{ jlcpcb: ["C14663"] }} footprint="0603" maxDecouplingTraceLength="100mm" connections={{ pin1: "net.VDD", pin2: "net.GND" }} pcbX={12} pcbY={-6} schX={5} schY={4} schOrientation="vertical" />
...
export { Grove12KeyCapacitiveI2CTouchSensorV2MPR121 }
export default Grove12KeyCapacitiveI2CTouchSensorV2MPR121
