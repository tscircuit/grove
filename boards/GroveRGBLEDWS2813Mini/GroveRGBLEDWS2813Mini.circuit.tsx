...
const GroveRGBLEDWS2813Mini = () => (
  <board name={"GroveRGBLEDWS2813Mini"} title={"Grove RGB LED WS2813 Mini"} width={"40mm"} height={"20mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"RGB LED WS2813 Mini"} pcbX={0} pcbY={8.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-8.5} fontSize="0.45mm" />
  </board>
)

export { GroveRGBLEDWS2813Mini }
export default GroveRGBLEDWS2813Mini
