...
- <trace#93898(from:.J1 > .pin1 to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#93899(from:.J1 > .pin3 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#93900(from:.J1 > .pin4 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#93901(from:.U1 > .P4 to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#93902(from:.U1 > .P8 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#93903(from:.U1 > .P3 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#93904(from:.U1 > .P5 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
