...
const GroveOxygenSensorProPreCalibration = () => (
  <board name={"GroveOxygenSensorProPreCalibration"} title={"Grove Oxygen Sensor Pro Pre calibration"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
