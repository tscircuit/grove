...
const GroveOxygenSensorProPreCalibration = () => (
  <board name={"GroveOxygenSensorProPreCalibration"} title={"Grove Oxygen Sensor Pro Pre calibration"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <resistor name="R_HEAT" resistance="33" tolerance="5%" manufacturerPartNumber="RC1206JR-0733RL" footprint="1206" connections={{ pin1: "net.VCC", pin2: "net.GND" }} pcbX={10} pcbY={-5} schX={8} schY={-5} />
    ...
    <silkscreentext text={"Oxygen Sensor Pro Pre calibrati…"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveOxygenSensorProPreCalibration }
export default GroveOxygenSensorProPreCalibration
