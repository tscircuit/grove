...
const GroveGasOSensorMIX8410 = () => (
  <board name={"GroveGasOSensorMIX8410"} title={"Grove - Gas O₂ Sensor(MIX8410)"} width={"60mm"} height={"38mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Gas O₂ Sensor(MIX8410)"} pcbX={0} pcbY={17.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-17.5} fontSize="0.45mm" />
  </board>
)

export { GroveGasOSensorMIX8410 }
export default GroveGasOSensorMIX8410
