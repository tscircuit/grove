...
Detailed Grove **Input Output** board model with a Grove I2CHub6Port controller controller,
decoupling, interface conditioning, explicit footprints, mounting holes, and
routed nets.

- Interface: `i2c`
- Board family: `utility`
- Primary part: `Grove I2CHub6Port controller` (MPN: `GROVE-GROVEI2CHUB6PORT`)
- Power rail: `5V`
