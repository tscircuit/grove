...
const GroveIMU9DOFLcm20600AK09918 = () => (
  <board name={"GroveIMU9DOFLcm20600AK09918"} title={"Grove - IMU 9DOF(lcm20600+AK09918)"} width={"34mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
