# DESIGN_REVIEW1 — Grove - Recorder V3

**Disposition:** NOT PRODUCTION READY
**Board directory:** `GroveRecorderV3`
...
This review is specific to the checked-in [board source](./GroveRecorderV3.circuit.tsx), its current generated circuit JSON, and its committed [PCB snapshot](./__snapshots__/GroveRecorderV3.circuit-pcb.snap.svg) / [schematic snapshot](./__snapshots__/GroveRecorderV3.circuit-schematic.snap.svg). A renderable snapshot is not fabrication approval.
...
- <trace#12444(from:.J1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12445(from:.J1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12446(from:.J1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12447(from:.U1 > .SIG to:net.SIG) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12448(from:.U1 > .VCC to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12449(from:.U1 > .GND to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12450(from:.C1 > .pin1 to:net.VCC) /> is missing a name. Add a name prop to make the trace easier to identify.
- <trace#12451(from:.C1 > .pin2 to:net.GND) /> is missing a name. Add a name prop to make the trace easier to identify.
