...
const GroveMiniFanV11 = () => (
  <board name={"GroveMiniFanV11"} title={"Grove Mini Fan v1 1"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" minViaEdgeToPadEdgeClearance="0.2mm" minViaPadDiameter="0.25mm">
    ...
    <silkscreentext text={"Mini Fan v1 1"} pcbX={0} pcbY={12.5} fontSize="0.6mm" />
    <silkscreentext text="HAND-AUTHORED" pcbX={0} pcbY={-12.5} fontSize="0.45mm" />
  </board>
)

export { GroveMiniFanV11 }
export default GroveMiniFanV11
