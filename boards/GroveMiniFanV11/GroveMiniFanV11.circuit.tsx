...
const GroveMiniFanV11 = () => (
  <board name={"GroveMiniFanV11"} title={"Grove Mini Fan v1 1"} width={"52mm"} height={"28mm"} borderRadius="1mm" solderMaskColor="blue" routingDisabled={false}>
